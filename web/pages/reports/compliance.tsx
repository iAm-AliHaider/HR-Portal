            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {complianceOverview.complianceRate}%
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  ...
                  {complianceOverview.totalRequirements}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {complianceOverview.nonCompliant}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {complianceOverview.upcomingDeadlines}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              {filteredRequirements.map((category) => {
                const complianceRate =
                  (category.compliant / category.total) * 100;
                return (
            ...
            {filteredDeadlines.length > 0 ? (
                      ...
                      return (
                        <tr key={item.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            ...
                            <span
                              className={`ml-2 text-xs inline-block px-2 py-0.5 rounded-full ${
                                days < 7
              ...
              <div className="flex items-center justify-center h-32 bg-gray-50 rounded-lg">
                <p className="text-gray-500">
                  No upcoming deadlines for the selected category
                </p>
              </div>
            )}
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-base">
                    {formatDate(complianceOverview.lastAudit)}
                  </p>
              ...
              <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-base">
                    {formatDate(complianceOverview.nextAudit)}
                  </p>
                  <p className="text-xs text-gray-500">
                    {daysUntil(complianceOverview.nextAudit)} days remaining
                  </p>
                </div>
              </div>
