...
export default function FinancialReportPage() {
  ...
  const filteredDepartmentBudgets =
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {financialOverview.fiscalYear} • {financialOverview.fiscalQuarter}{" "}
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {formatCurrency(financialOverview.totalBudget)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {formatCurrency(financialOverview.spent)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {formatCurrency(financialOverview.remaining)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold">
                  {financialOverview.budgetUtilization}%
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-gray-900 mb-2">
                {financialOverview.forecastAccuracy}%
              </p>
              <div className="flex items-center text-xs text-green-600">
