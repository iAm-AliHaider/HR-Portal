                ...
                <div className="flex items-center justify-center h-64">
                  <div className="text-center">
                    ...
                    <p className="text-4xl font-bold text-gray-900">
                      {workforceMetrics.openPositions}
                    </p>
          ...
          {activeTab === "demographics" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {workforceMetrics.diversity.gender.male}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        className="bg-blue-600 h-2.5 rounded-full"
                        style={{
                          width: `${workforceMetrics.diversity.gender.male}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {workforceMetrics.diversity.gender.female}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width: `${workforceMetrics.diversity.gender.female}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {workforceMetrics.diversity.gender.other}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width: `${workforceMetrics.diversity.gender.other}%`,
                        }}
                      ></div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  {Object.entries(workforceMetrics.diversity.ethnicity).map(
                    ([key, value]) => (
                      <div key={key}>
                        <div className="flex justify-between mb-1">
                          <span className="text-sm font-medium text-gray-700">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex items-center justify-center h-64">
                  <p className="text-gray-500">
                    Education level chart will be displayed here
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === "turnover" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex items-center justify-center h-64">
                  <p className="text-gray-500">
                    Department turnover chart will be displayed here
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex items-center justify-center h-64">
                  <p className="text-gray-500">
                    Retention rate chart will be displayed here
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === "performance" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {workforceMetrics.performance.exceeds}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        className="bg-green-600 h-2.5 rounded-full"
                        style={{
                          width: `${workforceMetrics.performance.exceeds}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {workforceMetrics.performance.meets}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        className="bg-blue-600 h-2.5 rounded-full"
                        style={{
                          width: `${workforceMetrics.performance.meets}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {workforceMetrics.performance.needsImprovement}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{
                          width: `${workforceMetrics.performance.needsImprovement}%`,
                        }}
                      ></div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex items-center justify-center h-64">
                  <p className="text-gray-500">
                    Performance vs tenure chart will be displayed here
                  </p>
                </div>
              </div>
