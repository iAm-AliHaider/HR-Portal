              ...
              <div key={attendance.id} className="border rounded-lg p-3">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${getStatusColor(attendance.status)}`}
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-medium">
                      {attendance.clockOut || "In Progress"}
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span
                      className={`font-medium ${attendance.overtimeHours > 0 ? "text-orange-600" : ""}`}
                    >
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">
                          {request.totalDays} days • {request.type}
                        </div>
                      </div>
                    </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {[
                  ...timeEntries,
                  ...todayAttendance.filter((a) => a.status !== "pto"),
                ].map((entry) => (
                  <tr key={entry.id} className="border-b hover:bg-gray-50">
                    <td className="p-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            {"position" in entry ? entry.position : ""}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="p-4">
                      <div
                        className={`font-medium ${entry.overtimeHours > 0 ? "text-orange-600" : ""}`}
                      >
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs ${getStatusColor(entry.status)}`}
                      >
              ...
              <div className="space-y-3">
                ...
                {schedule.type === "fixed" ? (
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium">
                        {schedule.minHours}-{schedule.maxHours}h
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="text-sm">
                  ...
                  <span className="font-medium ml-1">
                    {schedule.breakDuration || schedule.totalHours
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {["Engineering", "Sales", "Marketing", "HR"].map(
                (dept, index) => (
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Track employee time, manage schedules, and monitor attendance
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">
                  {selectedEmployee.name} - Attendance Details
                </h2>
                <button
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      <div>
                        ...
                        {selectedTimeEntry.employeeName ||
                      ...
                      <div>
                        ...
                        {selectedTimeEntry.clockIn}
                      </div>
                      <div>
                        <span className="font-medium">Clock Out:</span>{" "}
                        {selectedTimeEntry.clockOut || "In Progress"}
                      </div>
                      <div>
                        <span className="font-medium">Total Hours:</span>{" "}
                        {selectedTimeEntry.totalHours ||
                          selectedTimeEntry.hoursWorked}
                        h
                      </div>
                      <div>
                        <span className="font-medium">Overtime:</span>{" "}
                        {selectedTimeEntry.overtimeHours}h
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>
                        <span className="font-medium">Status:</span>
                        <span
                          className={`ml-1 px-2 py-1 rounded-full text-xs ${getStatusColor(selectedTimeEntry.status)}`}
                        >
        ...
        {showClockIn && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              Clock In/Out Modal{" "}
              <button onClick={() => setShowClockIn(false)}>Close</button>
            </div>
          </div>
        )}
        {showPTO && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              Request PTO Modal{" "}
              <button onClick={() => setShowPTO(false)}>Close</button>
            </div>
          </div>
        )}
        {showSchedule && (
