...
export default function DashboardAnalyticsPage() {
  ...
  if (loading) {
    return (
      <ModernDashboardLayout title="Dashboard Analytics" subtitle="Loading...">
  ...
  if (error) {
    return (
      <ModernDashboardLayout title="Dashboard Analytics">
        <div
                ...
                <div className="flex items-center justify-center h-64">
                  <div className="flex flex-col items-center">
                    <div className="flex space-x-8 mb-4">
                      <div className="flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-blue-500 mb-2 flex items-center justify-center text-white font-bold text-lg">
                          58%
                        </div>
                        <span className="text-sm font-medium">Male</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-pink-500 mb-2 flex items-center justify-center text-white font-bold text-lg">
                          40%
                        </div>
                        <span className="text-sm font-medium">Female</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-purple-500 mb-2 flex items-center justify-center text-white font-bold text-lg">
                          2%
                        </div>
              ...
              <div className="h-64 flex items-end space-x-2">
                {analytics?.monthlyRecruitment?.map((month) => {
                  ...
                  const maxValue = Math.max(
                    ...analytics.monthlyRecruitment.map((m) => m.value),
                  );
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-8">
              ...
              <div className="space-y-4">
                {analytics?.performanceRatings?.map((rating) => {
                  const totalValue = analytics.performanceRatings.reduce(
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-green-600">
                      +{analytics?.trends?.trainingEngagement || 0}%
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center justify-center h-64">
                  <div className="flex flex-col items-center">
                    <div className="flex space-x-8 mb-4">
                      ...
                      <div className="flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-green-500 mb-2 flex items-center justify-center text-white font-bold text-lg">
                          18%
                        </div>
                        <span className="text-sm font-medium">Webinars</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-yellow-500 mb-2 flex items-center justify-center text-white font-bold text-lg">
                          12%
                        </div>
