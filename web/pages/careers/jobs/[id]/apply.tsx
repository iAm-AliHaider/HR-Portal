    ...
    try {
      ...
      if (error) {
        ...
        const mockJob: Job = {
          ...
          type: "Full-time",
          description:
            "We are looking for a Senior Software Engineer to join our team and help build amazing products...",
          requirements:
            "At least 5 years of experience with modern JavaScript frameworks, strong problem-solving skills, experience with cloud platforms...",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        if (process.env.NODE_ENV === "development") {
          console.warn(
            "Application submission failed (dev mode):",
            error.message,
          );
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {!isAuthenticated ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Please sign in to your candidate account to apply for this
              position.
            </p>
            <div className="space-y-3">
              ...
              <Link
                ...
                className="w-full block bg-gray-100 text-gray-700 py-3 px-4 rounded-md hover:bg-gray-200 text-center"
              >
                Create Account
              </Link>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Please provide a link to your resume (Google Drive,
                      Dropbox, etc.)
                    </p>
                  </div>
