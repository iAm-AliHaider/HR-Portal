        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <Link href="/careers" className="inline-flex items-center text-blue-600 hover:text-blue-500 mr-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
                  <div className="flex items-center">
                    ...
                    <span className="text-yellow-800">
                      Application deadline: {formatDate(job.closing_date)} ({daysUntilClosing} days remaining)
                    </span>
                  </div>
                </div>
              )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Ready to Apply?</h3>
              ...
              <div className="mt-4 text-center">
                <Link href="/candidate/register" className="text-sm text-blue-600 hover:text-blue-500">
            ...
            {/* Share */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Share This Job</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                We're a fast-growing technology company building innovative solutions for modern businesses.
                Join our team of talented professionals and help shape the future of technology.
              </p>
              <Link href="/careers" className="text-blue-600 hover:text-blue-500 text-sm">
            ...
            {relatedJobs.length > 0 && (
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Similar Positions</h3>
                <div className="space-y-4">
                  {relatedJobs.map((relatedJob) => (
                    <div key={relatedJob.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                      <Link href={`/careers/jobs/${relatedJob.id}`}>
                        <h4 className="font-medium text-gray-900 hover:text-blue-600">{relatedJob.title}</h4>
                        <p className="text-sm text-gray-600">{relatedJob.location} • {relatedJob.type}</p>
                        <p className="text-sm text-green-600 font-medium">{relatedJob.salary_range}</p>
                      </Link>
                    </div>
                  ))}
                </div>
