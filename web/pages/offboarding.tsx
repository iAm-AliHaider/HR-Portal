  ...
  const mockOffboardingCases: OffboardingCase[] = [
    {
      ...
      knowledge_transfer: [
        {
          ...
          description:
            "Transfer knowledge about Project Alpha architecture and roadmap",
      ...
      notes:
        "Excellent employee leaving for career advancement. Maintain good relationship.",
        ...
        {isCreating ? (
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4">
              Create New Offboarding Case
            </h2>
            <p className="text-gray-600">
              Offboarding creation form would go here...
            </p>
                  ...
                  {offboardingCases.map((case_) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded ${getStatusColor(case_.status)}`}
                        >
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <span
                          className={`inline-flex px-2 py-1 text-xs rounded ${getPriorityColor(case_.priority)}`}
                        >
                          {case_.priority}
                        </span>
                        <span className="text-xs text-gray-500">
                          {getProgressPercentage(case_.checklist_items)}%
                          complete
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="px-6 py-4 border-b border-gray-200">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center space-x-2">
                        <span
                          className={`inline-flex px-3 py-1 text-sm font-semibold rounded ${getStatusColor(selectedCase.status)}`}
                        >
                          {selectedCase.status.replace("_", " ")}
                        </span>
                        <span
                          className={`inline-flex px-3 py-1 text-sm font-semibold rounded ${getPriorityColor(selectedCase.priority)}`}
                        >
                          ...
                          <div>
                            ...
                            <dl className="space-y-3">
                              ...
                              <div>
                                ...
                                <dd className="text-sm text-gray-900">
                                  {selectedCase.notice_period_days} days
                                </dd>
                              </div>
                            </dl>
                          </div>
                          <div>
                            ...
                            <dl className="space-y-3">
                              <div>
                                ...
                                <dd>
                                  <span
                                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded ${getTerminationTypeColor(selectedCase.termination_type)}`}
                                  >
                                    {selectedCase.termination_type.replace(
                                      "_",
                                      " ",
                                    )}
                                  </span>
                          ...
                          {selectedCase.checklist_items.map((item) => (
                            ...
                            >
                              <div className="flex justify-between items-start mb-2">
                                ...
                                <span
                                  className={`inline-flex px-2 py-1 text-xs font-semibold rounded ml-4 ${
                              ...
                              {item.completed_by && (
                                <div className="mt-2 text-sm text-gray-600">
                                  Completed by {item.completed_by} on{" "}
                                  {new Date(
                                    item.completed_at!,
                                  ).toLocaleDateString()}
                                </div>
                          ...
                          <div className="text-center py-8">
                            <div className="text-gray-400">
                              ...
                              <p className="text-gray-500 mb-4">
                                Add company assets that need to be returned.
                              </p>
                              <PermissionButton
                                permissions={[
                                  "employees.update",
                              ...
                              >
                                ...
                                {access.backup_required && (
                                  <div className="mt-1">
                                    <span
                                      className={`inline-flex px-2 py-1 text-xs font-semibold rounded ${
                                        access.backup_status === "completed"
                                          ? "bg-green-100 text-green-800"
                                          : access.backup_status === "pending"
                                            ? "bg-yellow-100 text-yellow-800"
                        ...
                        {selectedCase.knowledge_transfer.length > 0 ? (
                          ...
                          <div className="text-center py-8">
                            <div className="text-gray-400">
                              ...
                              <h4 className="text-lg font-medium mb-2">
                                No Knowledge Transfer Items
                              </h4>
                              <p className="text-gray-500 mb-4">
                                Add knowledge transfer items to ensure smooth
                                transition.
                              </p>
                              <PermissionButton
                                permissions={[
                        ...
                        {selectedCase.documents.length > 0 ? (
                          ...
                          <div className="text-center py-8">
                            <div className="text-gray-400">
                              ...
                              <p className="text-gray-500 mb-4">
                                Upload offboarding documents and forms.
                              </p>
                              <PermissionButton
                                permissions={[
                                  "employees.update",
                            ...
                            <div className="bg-green-50 p-4 rounded-lg">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                <div>
                                  ...
                                  <span className="ml-2 text-gray-900">
                                    $
                                    {selectedCase.final_settlement.final_salary.toLocaleString()}
                                  </span>
                                </div>
                                <div>
                                  <span className="font-medium text-gray-600">
                                  ...
                                  <span className="ml-2 text-gray-900">
                                    $
                                    {selectedCase.final_settlement.unused_leave_payment.toLocaleString()}
                                  </span>
                                </div>
                                <div>
                                  <span className="font-medium text-gray-600">
                                  ...
                                  <span className="ml-2 text-gray-900">
                                    $
                                    {selectedCase.final_settlement.bonus_payment.toLocaleString()}
                                  </span>
                                </div>
                                <div>
                                  <span className="font-medium text-gray-600">
                                  ...
                                  <span className="ml-2 text-gray-900 font-semibold">
                                    $
                                    {selectedCase.final_settlement.total_amount.toLocaleString()}
                                  </span>
                                </div>
                                <div>
                                  <span className="font-medium text-gray-600">
                  ...
                  <div className="text-gray-400">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={1.5}
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20a3 3 0 01-3-3v-2a3 3 0 013-3 3 3 0 013 3v2a3 3 0 01-3 3zm8-10a3 3 0 11-6 0 3 3 0 016 0z"
                      />
                    </svg>
                    <h3 className="text-xl font-medium mb-2">
                      Select an offboarding case to view details
                    </h3>
                    <p className="text-gray-500 mb-4">
                      Choose a case from the list to manage the offboarding
                      process.
                    </p>
                    <PermissionButton
                      permissions={[
