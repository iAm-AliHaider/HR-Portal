...
const PerformanceManagementPage = () => {
  ...
  const {
    ...
    onOpen: onCreateReviewOpen,
    onClose: onCreateReviewClose,
  } = useDisclosure();
  const {
    isOpen: isCreateGoalOpen,
    onOpen: onCreateGoalOpen,
  ...
  const stats = {
    ...
    avgRating:
      reviews
        ...
        reviews.filter((r) => r.overall_rating > 0).length || 0,
  };
      ...
      <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4}>
        <Card bg={cardBg} borderColor={borderColor}>
          <CardBody textAlign="center">
            <CircularProgress
              value={(stats.completedReviews / stats.totalReviews) * 100}
              color="green.400"
              size="80px"
            >
              <CircularProgressLabel fontSize="sm">
                {Math.round(
                  (stats.completedReviews / stats.totalReviews) * 100,
                )}
                %
              </CircularProgressLabel>
            </CircularProgress>
        ...
        <Card bg={cardBg} borderColor={borderColor}>
          <CardBody textAlign="center">
            <Text
              fontSize="3xl"
              fontWeight="bold"
              color={stats.overdueReviews > 0 ? "red.500" : "green.500"}
            >
                  ...
                  >
                    <Box flex={1}>
                      ...
                      <HStack spacing={2} mt={1}>
                        ...
                        <Badge
                          colorScheme={getPriorityColor(goal.priority)}
                          variant="subtle"
                          fontSize="xs"
                        >
                          {goal.priority}
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive performance management and goal tracking system"
        />
      </Head>
          ...
          <Container maxW="full" py={6}>
            ...
            >
              <Box>
                ...
                <Text color="gray.600">
                  Track performance reviews, goals, and employee development
                </Text>
              </Box>
                  ...
                  <Center py={20}>
                    <VStack spacing={4}>
                      ...
                      <Text fontSize="sm" color="gray.400">
                        Advanced analytics and reporting dashboard coming
                        soon...
                      </Text>
                ...
                <VStack spacing={6} align="stretch">
                  ...
                  >
                    ...
                    <Stat textAlign="center">
                      ...
                      <Badge
                        colorScheme={getStatusColor(selectedReview.status)}
                        variant="subtle"
                        fontSize="lg"
                      >
                  ...
                  {Object.keys(selectedReview.competency_scores).length > 0 && (
                    <Box>
                      ...
                      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                        {Object.entries(selectedReview.competency_scores).map(
                          ([competency, score]) => (
                            <Box key={competency}>
                              <Flex justify="space-between" mb={1}>
                  ...
                  {selectedReview.areas_for_improvement.length > 0 && (
                    <Box>
                      ...
                      <VStack align="stretch" spacing={1}>
                        {selectedReview.areas_for_improvement.map(
                          (area, index) => (
                            <Text key={index} fontSize="sm">
                              • {area}
                            </Text>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              <ButtonGroup spacing={2}>
                ...
                <Button colorScheme="blue">Edit Goal</Button>
              </ButtonGroup>
            </ModalFooter>
          </ModalContent>
        </Modal>
