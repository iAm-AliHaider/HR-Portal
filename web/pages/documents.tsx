              ...
              <div key={doc.id} className="border rounded-lg p-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${getSecurityLevelColor(doc.securityLevel)}`}
                    >
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {["Employment", "Performance", "Training", "Policy", "Legal"].map(
                (category, index) => (
                  <div
                    key={category}
                  ...
                  >
                    <div className="flex items-center">
                      <span className="text-xl mr-3">
                        {getDocumentTypeIcon(category.toLowerCase())}
                      </span>
                      <div>
                  ...
                  <tr key={request.id} className="border-b hover:bg-gray-50">
                    <td className="p-4">
                      <div className="font-medium">
                        {request.documentName.slice(0, 30)}...
                      </div>
                      <div className="text-sm text-gray-600">
                        {request.department}
                      </div>
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Manage documents, templates, signatures, and compliance tracking
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      {selectedDocument.category} • {selectedDocument.size} • v
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>
                        ...
                        <span
                          className={`ml-1 px-2 py-1 rounded-full text-xs ${getStatusColor(selectedDocument.status)}`}
                        >
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      <div>
                        ...
                        <span
                          className={`ml-1 px-2 py-1 rounded-full text-xs ${getSecurityLevelColor(selectedDocument.securityLevel)}`}
                        >
                      ...
                      <div>
                        ...
                        {selectedDocument.retentionPeriod}
                      </div>
                      <div>
                        <span className="font-medium">Signature Required:</span>{" "}
                        {selectedDocument.signatureRequired ? "Yes" : "No"}
                      </div>
