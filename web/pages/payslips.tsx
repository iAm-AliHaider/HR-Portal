    ...
    corrections: [
      {
        ...
        resolution:
          "Confirmed tax rate is correct based on current tax bracket.",
      },
    ],
    yearToDate: {
      earnings: 53000,
...
export default function PayslipsPage() {
  ...
  const handleCorrectionRequest = () => {
    ...
    setSelectedPayslip(
      updatedPayslips.find((p) => p.id === selectedPayslip.id),
    );
      ...
      <div className="container px-4 sm:px-6 mx-auto py-6 space-y-6 max-w-full lg:max-w-6xl">
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Overview of your earnings and deductions for the selected year
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              <div className="flex flex-col items-center p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-blue-700">
                  {formatCurrency(
                    filteredPayslips[0]?.yearToDate.earnings || 0,
                  )}
                </p>
              </div>
          ...
          {filteredPayslips.length > 0 ? (
            <div className="space-y-4 overflow-x-auto">
              {filteredPayslips.map((payslip) => (
                <Card
                  key={payslip.id}
                  className="overflow-hidden hover:border-blue-200 transition-colors"
                >
                        ...
                        <div className="mt-1 flex flex-wrap gap-1">
                          ...
                          {payslip.corrections.length > 0 && (
                            <Badge className="ml-2 bg-blue-100 text-blue-800">
                              {payslip.corrections.length}{" "}
                              {payslip.corrections.length === 1
                                ? "Correction"
                                : "Corrections"}
                            </Badge>
                          )}
              ...
              <>
                <DialogHeader>
                  <div className="flex items-center justify-between">
                    <DialogTitle>
                      Payslip for {selectedPayslip.period}
                    </DialogTitle>
                    <div className="flex gap-2">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          alert(
                            `Printing payslip for ${selectedPayslip.period}`,
                          );
                        }}
                      >
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          alert(
                            `Emailing payslip for ${selectedPayslip.period}`,
                          );
                        }}
                      >
                      ...
                      <Button
                        ...
                        onClick={() => {
                          // In a real app, this would download the PDF
                          alert(
                            `Downloading payslip for ${selectedPayslip.period}`,
                          );
                        }}
                      >
                        <Download className="h-4 w-4 mr-1" />
                  ...
                  <DialogDescription>
                    Issued on {formatDate(selectedPayslip.issueDate)} • Payment
                    Date: {formatDate(selectedPayslip.paymentDate)}
                  </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <CardContent className="p-4">
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between py-1">
                              ...
                              <span className="font-medium">
                                {formatCurrency(
                                  selectedPayslip.earnings.overtime,
                                )}
                              </span>
                            </div>
                            ...
                            <div className="flex justify-between py-1">
                              <span>Bonus</span>
                              <span className="font-medium">
                                {formatCurrency(selectedPayslip.earnings.bonus)}
                              </span>
                            </div>
                            ...
                            <div className="flex justify-between py-1 font-bold">
                              ...
                              <span className="text-green-700">
                                {formatCurrency(selectedPayslip.earnings.total)}
                              </span>
                            </div>
                          </div>
                        </CardContent>
                        ...
                        <CardContent className="p-4">
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between py-1">
                              ...
                              <span className="font-medium">
                                {formatCurrency(
                                  selectedPayslip.deductions.insurance,
                                )}
                              </span>
                            </div>
                            ...
                            <div className="flex justify-between py-1 font-bold">
                              ...
                              <span className="text-red-700">
                                {formatCurrency(
                                  selectedPayslip.deductions.total,
                                )}
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                Via {selectedPayslip.paymentMethod}
                              </p>
                            </div>
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            <div className="text-center p-2 bg-gray-50 rounded">
                              ...
                              <p className="font-bold">
                                {formatCurrency(
                                  selectedPayslip.yearToDate.earnings,
                                )}
                              </p>
                            </div>
                            ...
                            <div className="text-center p-2 bg-gray-50 rounded">
                              ...
                              <p className="font-bold">
                                {formatCurrency(selectedPayslip.yearToDate.tax)}
                              </p>
                            </div>
                            ...
                            <div className="text-center p-2 bg-gray-50 rounded">
                              ...
                              <p className="font-bold">
                                {formatCurrency(
                                  selectedPayslip.yearToDate.pension,
                                )}
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="space-y-6">
                        ...
                        <CardContent className="p-4">
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {formatDate(selectedPayslip.issueDate)}
                              </p>
                            </div>
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-500 mb-2">
                        Correction Requests (
                        {selectedPayslip.corrections.length})
                      </h3>
                        ...
                        <Card>
                          <CardContent className="p-4">
                            <div className="space-y-4">
                              {selectedPayslip.corrections.map(
                                (correction, index) => (
                                  <div
                                    key={correction.id}
                                  ...
                                  >
                                    ...
                                    <div className="text-xs text-gray-500 flex flex-wrap gap-x-3">
                                      <span>
                                        Requested: {formatDate(correction.date)}
                                      </span>
                          ...
                          <CardContent className="p-4">
                            <div className="text-center py-6">
                              ...
                              <p className="text-gray-500">
                                No correction requests for this payslip
                              </p>
                            </div>
                          </CardContent>
                        </Card>
                        ...
                        <Card>
                          <CardContent className="p-4">
                            <Textarea
                              ...
                              onChange={(e) =>
                                setNewCorrectionRequest(e.target.value)
                              }
                              className="mb-2"
                            />
                            <Button
