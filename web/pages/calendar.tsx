...
const CalendarEventModal = dynamic(
  () => import("@/components/ui/CalendarEventModal"),
  {
    ssr: false,
...
const EventCard = ({
  ...
  const colorClass =
    typeColors[event.type] || "bg-gray-100 text-gray-800 border-gray-300";
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <Button variant="solid" size="sm" onClick={handleCreateEvent}>
                <svg
              ...
              <div className="grid grid-cols-7 h-[700px]">
                ...
                {monthDays.map((day, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`text-right mb-1 ${isToday ? "font-bold text-blue-600" : ""}`}
                      >
                        {day.date.getDate()}
                      </div>
                ...
                <div className="relative flex flex-1">
                  ...
                  <div className="w-16 flex-shrink-0 border-r">
                    {hourRange.map((hour) => (
                      <div
                        key={hour}
                        className="h-[60px] border-b px-2 text-xs text-right text-gray-500"
                      >
                        {formatTime(hour)}
                      </div>
                    ))}
