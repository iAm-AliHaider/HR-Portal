  ...
  1: [
    {
      ...
      description: "Started as HR Specialist",
    },
    {
      date: "2020-01-15",
      title: "Promotion",
    ...
    },
    {
      ...
      description: "Received Outstanding Service Award",
    },
  ],
  2: [
    {
  ...
  3: [
    {
      date: "2020-07-15",
      title: "Joined the company",
      description: "Started as Junior Software Engineer",
    },
    {
      date: "2021-06-20",
      title: "Promotion",
  ...
  1: [
    {
      ...
      quarter: "Q4",
      rating: 4.8,
      comments: "Outstanding performance in leading HR initiatives.",
    },
    {
      year: 2021,
      quarter: "Q3",
      rating: 4.7,
      comments: "Strong leadership and team management skills.",
    },
    {
      year: 2021,
      quarter: "Q2",
      rating: 4.5,
      comments: "Excellent work in improving onboarding processes.",
    },
    {
      year: 2021,
      quarter: "Q1",
      rating: 4.4,
      comments: "Very good work in employee relations.",
    },
  ],
  2: [
    {
      ...
      quarter: "Q4",
      rating: 5.0,
      comments: "Exceptional leadership driving company growth.",
    },
    {
      year: 2021,
      quarter: "Q3",
      rating: 4.9,
      comments: "Strategic vision continues to benefit company.",
    },
  ],
  3: [
    {
      ...
      quarter: "Q4",
      rating: 4.2,
      comments: "Great technical skills and teamwork.",
    },
    {
      year: 2021,
      quarter: "Q3",
      rating: 4.0,
      comments: "Good progress in project deliverables.",
    },
  ],
};
...
const getDirectReports = (managerId) => {
  return MOCK_PEOPLE.filter(
    (person) =>
      person.manager === MOCK_PEOPLE.find((p) => p.id === managerId)?.name,
  );
};
...
const EmployeeProfile = () => {
  ...
  useEffect(() => {
    if (id) {
      ...
      const employeeData = MOCK_PEOPLE.find(
      ...
      if (employeeData) {
        ...
        if (employeeData.manager) {
          const managerData = MOCK_PEOPLE.find(
            (person) => person.name === employeeData.manager,
          );
      ...
      content: (
        <div className="space-y-8">
          {employmentHistory.length > 0 ? (
            <Timeline
              items={employmentHistory.map((item) => ({
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      PDF • 2.3 MB • Uploaded {formatDate("2019-05-12")}
                    </div>
                  </div>
                </div>
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      PDF • 1.1 MB • Uploaded {formatDate("2019-05-12")}
                    </div>
                  </div>
                </div>
                <div className="mt-3 flex justify-end">
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      XLSX • 0.5 MB • Uploaded {formatDate("2021-12-15")}
                    </div>
                  </div>
                </div>
                <div className="mt-3 flex justify-end">
