...
import { RefreshCw, AlertTriangle, CheckCircle, Clock, Server, Database, Globe } from 'lucide-react';
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        {check.icon}
                        <CardTitle className="ml-2 text-lg">{check.name}</CardTitle>
                      </div>
              ...
              <CardContent>
                <div className="space-y-2">
                  {Object.entries(environment).map(([key, value]) => (
                    <div key={key} className="grid grid-cols-3 py-2 border-b border-gray-100">
