        ...
        <main className="flex-1 p-6">
          <div className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-md border border-red-200 mt-8">
            <h2 className="text-xl font-semibold mb-4">
              An error occurred in the debug interface
            </h2>
            <p className="mb-6">
              There was a problem loading this debug page. This could be due to
              authentication issues or an API connection problem.
            </p>
