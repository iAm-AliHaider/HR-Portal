                ...
                .map((skill) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div
                        className={`font-medium ${getDemandColor(skill.demand)}`}
                      >
                      ...
                      <div className="flex items-center">
                        <div className="w-16 bg-gray-200 rounded-full h-2 mr-2">
                          <div
                            ...
                            style={{
                              width: `${(skill.avgProficiency / 4) * 100}%`,
                            }}
                          ></div>
                        </div>
                        <span className="text-sm">
                          {skill.avgProficiency.toFixed(1)}/4
                        </span>
                      </div>
                    </td>
                    <td className="p-2">
                  ...
                  {department.criticalGaps.map((gap, gapIndex) => (
                    <div key={gapIndex} className="border rounded-lg p-3">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span
                          className={`px-2 py-1 rounded-full text-xs ${getGapLevelColor(gap.gapLevel)}`}
                        >
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Track competencies, identify gaps, and plan development
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      {selectedEmployee.overallScore.toFixed(1)}/4
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        ...
                        {selectedSkill.avgProficiency.toFixed(1)}/4
                      </div>
                      <div>
                        <span className="font-medium">Demand Level:</span>
                        <span
                          className={`ml-1 font-medium ${getDemandColor(selectedSkill.demand)}`}
                        >
