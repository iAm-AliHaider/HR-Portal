  ...
  const renderContent = () => {
    switch (activeTab) {
      case "employees":
        ...
        if (employeesError)
          return (
            <div className="text-red-500 py-8">Error: {employeesError}</div>
          );
      ...
      case "jobs":
        ...
        if (jobsError)
          return <div className="text-red-500 py-8">Error: {jobsError}</div>;
      ...
      case "leave":
        ...
        if (leaveError)
          return <div className="text-red-500 py-8">Error: {leaveError}</div>;
      ...
      case "training":
        ...
        if (coursesError)
          return <div className="text-red-500 py-8">Error: {coursesError}</div>;
      ...
      case "compliance":
        if (complianceLoading)
          return <div className="text-center py-8">Loading compliance...</div>;
        if (complianceError)
          return (
            <div className="text-red-500 py-8">Error: {complianceError}</div>
          );
      ...
      case "workflows":
        ...
        if (workflowsError)
          return (
            <div className="text-red-500 py-8">Error: {workflowsError}</div>
          );
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Comprehensive view of all mock data working perfectly until Supabase
            setup
          </p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-green-700">
                ...
                <p>
                  • {courses.length} training courses, {requirements.length}{" "}
                  compliance items, {workflows.length} workflows
                </p>
