...
const recentActivities = [
  ...
  {
    type: "approval",
    message: "Expense report approved for Team Lunch",
    time: "2 days ago",
    status: "success",
  },
];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-green-700 mt-1">
                  Your HR Portal now features a beautiful, modern interface with
                  enhanced navigation, better user experience, and all previous
                  fixes maintained.
                </p>
              </div>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p
                        className={`text-3xl font-bold text-gray-900 mt-2${stat.trend === "up" ? " text-green-600" : " text-red-600"}`}
                      >
                        {stat.value}
                      </p>
                      <p
                        className={`text-sm mt-1 ${stat.trend === "up" ? "text-green-600" : "text-red-600"}`}
                      >
                ...
                {quickActions.map((action, index) => (
                  <Link key={index} href={action.href}>
                    <div className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                      <div
                        className={`p-3 rounded-full bg-${action.color}-50 mb-3`}
                      >
                        <action.icon
