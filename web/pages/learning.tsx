    ...
    const loadMockData = () => {
      const mockCourses: Course[] = [
        ...
        },
        {
          ...
          description:
            "Boost your productivity with effective time management.",
      ...
      const mockLearningPaths: LearningPath[] = [
        {
          ...
          description:
            "Complete learning path to become a full stack web developer",
          courses: ["1", "2", "3"],
          completed: 2,
          total: 3,
        ...
        },
        {
          ...
          description:
            "Develop comprehensive management and leadership capabilities",
          courses: ["4", "5"],
          completed: 0,
          total: 2,
          difficulty: "advanced",
        ...
        },
        {
          ...
          description:
            "Master data analysis tools and techniques for business insights",
          courses: ["6"],
          completed: 1,
          total: 1,
          difficulty: "intermediate",
              ...
              .map((course) => (
                <div key={course.id} className="border rounded-lg p-4">
                  <div className="flex items-center mb-3">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${getLevelColor(course.level)}`}
                    >
                      {course.level}
                    </span>
                  </div>
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex flex-col items-end">
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${getLevelColor(course.level)} mb-1`}
                    >
                      {course.level}
                    </span>
                    <span
          ...
          <Card key={path.id}>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs ${getLevelColor(path.difficulty)}`}
                >
                  {path.difficulty}
                </span>
              </div>
              ...
              .map((course) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Issued by {course.instructor}
                  </p>

                  <div className="space-y-1 text-xs text-gray-500 mb-3">
                    <div>
                      Earned:{" "}
                      {new Date(course.certificate).toLocaleDateString()}
                    </div>
                    <div>
                      Expires:{" "}
                      {new Date(course.certificate).toLocaleDateString()}
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Expand your skills and advance your career through continuous
            learning
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      ⭐ {selectedCourse.rating} ({selectedCourse.enrolledCount}{" "}
                      students)
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>
                        ...
                        <span
                          className={`ml-1 px-2 py-1 rounded-full text-xs ${getLevelColor(selectedCourse.level)}`}
                        >
                      ...
                      <div>
                        ...
                        {selectedCourse.price === "free" ? "Free" : "$99"}
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      {Math.round(
                        (selectedPath.completed / selectedPath.total) * 100,
                      )}
                      %
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2 mb-3">
                    <div
                      className="bg-green-600 h-2 rounded-full"
                      style={{
                        width: `${(selectedPath.completed / selectedPath.total) * 100}%`,
                      }}
                    ></div>
                  </div>
                </div>
