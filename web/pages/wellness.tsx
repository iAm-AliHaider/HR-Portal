...
const Wellness = () => {
  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {wellnessChallenges.filter(c => c.status === 'active').map((challenge) => (
              <div key={challenge.id} className="border rounded-lg p-4">
                ...
                <Button className="w-full mt-2" size="sm">Join Challenge</Button>
              </div>
            ))}
          </div>
        </CardContent>
              ...
              <div key={index} className="border rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <div className={`w-3 h-3 rounded-full mr-2 ${
                    ...
                    resource.type === 'hotline' ? 'bg-orange-500' :
                    resource.type === 'training' ? 'bg-blue-500' : 'bg-green-500'
                  }`}></div>
                  <h3 className="font-medium">{resource.title}</h3>
                </div>
                <p className="text-sm text-gray-600 mb-2">{resource.description}</p>
                <div className="text-sm font-medium text-blue-600">{resource.contact}</div>
              </div>
            ))}
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <Button className="w-full" variant="outline">Stress Level Assessment</Button>
            <Button className="w-full" variant="outline">Burnout Risk Evaluation</Button>
            <Button className="w-full" variant="outline">Work-Life Balance Check</Button>
            <Button className="w-full" variant="outline">Mental Health Screening</Button>
          </div>
        </CardContent>
      </Card>
    </div>
  ...
  return (
    <DashboardLayout>
      <div className="p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Employee Wellness</h1>
          <p className="text-gray-600">Manage your health and well-being at work</p>
        </div>
