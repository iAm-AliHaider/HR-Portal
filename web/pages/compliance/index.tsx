...
export default function ComplianceTrainingPage() {
  ...
  const completionRate = trainings.reduce((sum, t) => sum + t.completionRate, 0) / totalTrainings || 0;
  ...
  const filteredTrainings = trainings.filter(training => {
    ...
    if (activeTab === 'required') return training.requiredFor.includes('All Employees');
  ...
  return (
    <ModernDashboardLayout title="Compliance Training" subtitle="Manage and track mandatory compliance training modules">
      {/* Statistics Cards */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-gray-600 text-sm font-medium">Total Trainings</h2>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-gray-600 text-sm font-medium">Active Trainings</h2>
              <p className="text-2xl font-semibold text-gray-800">{activeTrainings}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-gray-600 text-sm font-medium">Overdue Trainings</h2>
              <p className="text-2xl font-semibold text-gray-800">{overdueTrainings}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-gray-600 text-sm font-medium">Avg. Completion Rate</h2>
              <p className="text-2xl font-semibold text-gray-800">{Math.round(completionRate)}%</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <ul className="divide-y divide-gray-200">
          {filteredTrainings.length === 0 ? (
            ...
            filteredTrainings.map((training) => {
              ...
              const dueDate = new Date(training.dueDate);
              const isOverdue = dueDate < new Date() && training.completionRate < 100;
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <div className="flex items-center">
                              ...
                              {training.requiredFor.includes('All Employees') && (
                            ...
                            <div className="mt-1 text-sm text-gray-500">
                              ...
                              <p className="mt-1">
                                ...
                                <span className="font-medium ml-2">Duration:</span> {training.duration} | 
                                <span className="font-medium ml-2">Due:</span> {new Date(training.dueDate).toLocaleDateString()}
                              </p>
                            </div>
                          </div>
                        </div>
