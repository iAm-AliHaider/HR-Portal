...
const OrgChartDirectory = () => {
  ...
  const departments = [
    ...
    },
    {
      ...
      description:
        "Employee relations, recruitment, and organizational development",
      headId: "chro-001",
                      ...
                      .map((exec) => (
                        <div key={exec.id} className="text-center">
                          ...
                          <div className="flex justify-center mt-4 space-x-4">
                            {organizationStructure
                              .filter((emp) => emp.parentId === exec.id)
                              .map((director) => (
                                <div
                                  key={director.id}
            ...
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-3">
                ...
                <span className="text-lg">
                  {getWorkLocationIcon(employee.workLocation)}
                </span>
              </div>
          ...
          <Card key={dept.id}>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs ${getStatusColor(dept.status)}`}
                >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {team.department} • Led by {team.leadName}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-lg">
                    {getWorkLocationIcon(team.workStyle)}
                  </span>
                  <span
                    className={`px-2 py-1 rounded-full text-xs ${getStatusColor(team.status)}`}
                  >
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div>
                      ...
                      {(team.budget / 1000).toLocaleString()}K
                    </div>
                  </div>
                </div>
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Explore organizational structure, employee directory, and team
            information
          </p>
        </div>
                    ...
                    <div className="space-y-2 text-sm">
                      {selectedEmployee.parentId && (
                        <div>
                          ...
                          {organizationStructure.find(
                            (emp) => emp.id === selectedEmployee.parentId,
                          )?.name || "N/A"}
                        </div>
                      )}
                      ...
                      {selectedEmployee.employeeCount > 0 && (
                        <div>
                          ...
                          {selectedEmployee.employeeCount}
                        </div>
                      )}
                      <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Led by {selectedDepartment.headName}
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        ...
                        {new Date(selectedDepartment.established).getFullYear()}
                      </div>
                      <div>
