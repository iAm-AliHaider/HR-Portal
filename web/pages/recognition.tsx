...
const EmployeeRecognition = () => {
  ...
  const recognitions = [
    {
      ...
      category: "performance",
      reason:
        "Exceeded quarterly sales targets by 150% and mentored 3 new team members",
    ...
    },
    {
      ...
      category: "innovation",
      reason:
        "Developed automated testing framework that reduced deployment time by 60%",
    ...
    },
    {
      ...
      category: "teamwork",
      reason:
        "Coordinated cross-functional project that delivered ahead of schedule",
  ...
  const recentRecognitions = [
    ...
    },
    {
      ...
      type: "approval",
      message:
        "Emily Chen received Team Player Award for exceptional collaboration",
      time: "5 hours ago",
      avatar: "👩‍🎨",
    },
    {
            ...
            {recognitionPrograms.slice(0, 4).map((program) => (
              <div key={program.id} className="border rounded-lg p-4">
                ...
                <div className="flex justify-between items-center text-xs text-gray-500">
                  ...
                  <span>
                    Due: {new Date(program.nextDeadline).toLocaleDateString()}
                  </span>
                </div>
              </div>
            ))}
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-gray-600">
                      {person.recognitions} recognitions
                    </div>
                  </div>
                </div>
              ))}
              ...
              <tbody>
                {recognitions.map((recognition) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      {new Date(recognition.dateSubmitted).toLocaleDateString()}
                    </td>
                    <td className="p-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs ${getStatusColor(recognition.status)}`}
                      >
                        {recognition.status.charAt(0).toUpperCase() +
                          recognition.status.slice(1)}
                      </span>
                    </td>
                    <td className="p-4">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>
                        ...
                        {new Date(
                          selectedRecognition.dateSubmitted,
                        ).toLocaleDateString()}
                      </div>
                      <div>
                        <span className="font-medium">Points:</span>{" "}
                        {selectedRecognition.points}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <span
                    className={`px-3 py-1 rounded-full text-sm ${getStatusColor(selectedRecognition.status)}`}
                  >
                    {selectedRecognition.status.charAt(0).toUpperCase() +
                      selectedRecognition.status.slice(1)}
                  </span>
