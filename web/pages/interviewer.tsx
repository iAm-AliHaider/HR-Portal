...
const mockUsers: User[] = [
  { id: 'u1', org_id: 'org1', email: 'alice@example.com', full_name: 'Alice Smith', role: 'candidate', status: 'candidate', created_at: '2024-06-01T10:00:00Z' },
  { id: 'u2', org_id: 'org1', email: 'bob@example.com', full_name: 'Bob Lee', role: 'candidate', status: 'candidate', created_at: '2024-06-01T10:00:00Z' },
];
            ...
            return (
              <Card key={interview.id} className="hover:shadow-lg transition">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="text-gray-600">Interview for <span className="font-medium">{job.title}</span></div>
                  <div className="text-sm text-gray-400">Scheduled: {new Date(interview.scheduled_at).toLocaleString()}</div>
                  <div className="text-xs text-blue-600">Status: {interview.status}</div>
                </div>
              </Card>
            );
          })}
