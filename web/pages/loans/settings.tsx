    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.global_settings) {
          setProgramSettings({
            max_active_loans_per_employee:
              data.global_settings.max_active_loans_per_employee || 2,
            min_credit_score: data.global_settings.min_credit_score || 650,
            grace_period_days: data.global_settings.grace_period_days || 7,
            late_fee_percentage:
              data.global_settings.late_fee_percentage || 2.0,
            prepayment_penalty: data.global_settings.prepayment_penalty || 0,
            eligibility_period_months:
              data.global_settings.eligibility_period_months || 12,
            default_payment_method:
              data.global_settings.default_payment_method || "Salary Deduction",
            disbursement_time_days:
              data.global_settings.disbursement_time_days || 3,
            approval_workflow: data.global_settings.approval_workflow || [
              "HR Manager",
              "Finance Director",
            ],
          });
        ...
        const mockLoanTypes = [
          ...
          },
          {
            ...
            description:
              "Loans for higher education and professional development",
            required_documents: [
              "Identity proof",
              "Admission letter",
          ...
          },
          {
            ...
            required_documents: [
              "Identity proof",
              "Emergency proof (medical bills, etc.)",
              "Salary statement",
            ],
            status: "active",
          },
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <p className="text-gray-600 mb-6">
          You don't have permission to access the loan settings page.
        </p>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Configure the company loan program settings"
        />
      </Head>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Loan Program Settings
            </h1>
            <p className="text-gray-600 mt-1">
              Configure loan types and program parameters
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <Tabs value={activeTab}>
            <TabsList>
              ...
              <TabsTrigger value="program-settings">
                Program Settings
              </TabsTrigger>
            </TabsList>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        Configure the types of loans available to employees
                      </CardDescription>
                    </div>
                    <Button
                      onClick={() => {
                    ...
                    {loanTypes.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 mb-4">
                          Add your first loan type to get started
                        </p>
                        <Button
                          onClick={() => {
                            setEditingLoanType(null);
                          ...
                          >
                            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-4">
                              ...
                              <div className="flex gap-2">
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    handleToggleLoanTypeStatus(loanType.id)
                                  }
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="text-sm">
                                  {loanType.interest_rate_min}%-
                                  {loanType.interest_rate_max}%
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="mt-4">
                              ...
                              <ul className="list-disc pl-5 text-sm space-y-1">
                                {loanType.required_documents &&
                                  loanType.required_documents.map(
            ...
            <TabsContent value="program-settings">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure global settings for the loan program
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ProgramSettingsForm
...
function LoanTypeEditForm({
  loanType,
  onSave,
  onCancel,
  isSaving,
}: LoanTypeEditFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {loanType ? `Edit ${loanType.name}` : "Add New Loan Type"}
        </CardTitle>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    min_term_months: parseInt(e.target.value),
                  })
                }
              />
            </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                max_active_loans_per_employee: parseInt(e.target.value),
              })
            }
          />
          <p className="mt-1 text-xs text-gray-500">
            Maximum number of loans an employee can have at once
          </p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                min_credit_score: parseInt(e.target.value),
              })
            }
          />
          <p className="mt-1 text-xs text-gray-500">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-gray-500">
            Grace period before a payment is considered late
          </p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                prepayment_penalty: parseFloat(e.target.value),
              })
            }
          />
          <p className="mt-1 text-xs text-gray-500">
            Penalty for early loan repayment (0 for no penalty)
          </p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                disbursement_time_days: parseInt(e.target.value),
              })
            }
          />
          <p className="mt-1 text-xs text-gray-500">
            Standard time for loan disbursement after approval
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Default method for loan repayments
          </p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                eligibility_period_months: parseInt(e.target.value),
              })
            }
          />
          <p className="mt-1 text-xs text-gray-500">
            Minimum employment period before loan eligibility
          </p>
        </div>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-600 mt-1">
              These settings apply to all loan types across the organization.
              Changes to these settings will affect all future loan applications
              and may impact existing loans.
            </p>
          </div>
        </div>
      </div>
