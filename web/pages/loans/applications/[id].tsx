...
const mockApplicationData: Record<string, LoanApplication> = {
  'LN-2023-001': {
    ...
    amount: 25000,
    term: 3, // years
    purpose: 'Home renovation and repairs due to water damage in the bathroom and kitchen areas.',
    ...
    documents: [
      { id: 1, name: 'Salary Statement.pdf', type: 'salary_proof', uploadDate: '2023-11-15' },
      { id: 2, name: 'ID Proof.pdf', type: 'identity_proof', uploadDate: '2023-11-15' },
    ],
    timeline: [
      { date: '2023-11-15T10:30:00', action: 'Application Submitted', actor: 'Alex Johnson' },
      { date: '2023-11-16T14:15:00', action: 'Documentation Verified', actor: 'HR Team' },
      { date: '2023-11-17T09:45:00', action: 'Finance Review Completed', actor: 'Finance Department' },
      { date: '2023-11-18T11:20:00', action: 'Application Approved', actor: 'Jane Smith' },
    ]
  },
  'LN-2023-002': {
    id: 'LN-2023-002',
    ...
    amount: 75000,
    term: 5, // years
    purpose: 'To pursue a part-time Masters degree in Computer Science to enhance skills relevant to current role.',
    repaymentMethod: 'Bank Transfer',
    applicationDate: '2023-11-10',
    status: 'Pending Approval',
    documents: [
      { id: 1, name: 'University Admission Letter.pdf', type: 'education_proof', uploadDate: '2023-11-10' },
      { id: 2, name: 'Course Fee Structure.pdf', type: 'fee_proof', uploadDate: '2023-11-10' },
      { id: 3, name: 'Salary Statement.pdf', type: 'salary_proof', uploadDate: '2023-11-10' },
    ],
    notes: '',
    timeline: [
      { date: '2023-11-10T15:45:00', action: 'Application Submitted', actor: 'Jamie Smith' },
      { date: '2023-11-12T10:30:00', action: 'Documentation Verified', actor: 'HR Team' },
      { date: '2023-11-14T14:20:00', action: 'Pending Manager Approval', actor: 'System' },
    ]
  },
  'LN-2023-003': {
    id: 'LN-2023-003',
    ...
    amount: 15000,
    term: 1, // year
    purpose: 'Medical emergency - unexpected hospital expenses for dependent parent.',
    repaymentMethod: 'Salary Deduction',
    applicationDate: '2023-11-08',
    status: 'Under Review',
    documents: [
      { id: 1, name: 'Medical Bills.pdf', type: 'expense_proof', uploadDate: '2023-11-08' },
      { id: 2, name: 'Hospital Report.pdf', type: 'medical_proof', uploadDate: '2023-11-08' },
    ],
    notes: 'Urgent approval requested due to nature of emergency. HR director suggested expedited process.',
    timeline: [
      { date: '2023-11-08T09:15:00', action: 'Emergency Application Submitted', actor: 'Taylor Wilson' },
      { date: '2023-11-08T11:30:00', action: 'Initial Review Completed', actor: 'HR Team' },
      { date: '2023-11-08T16:45:00', action: 'Additional Documentation Requested', actor: 'Finance Department' },
      { date: '2023-11-09T10:20:00', action: 'Additional Documents Submitted', actor: 'Taylor Wilson' },
      { date: '2023-11-09T14:30:00', action: 'Under Final Review', actor: 'Finance Manager' },
    ]
  },
  'LN-2023-004': {
    id: 'LN-2023-004',
    ...
    documents: [
      { id: 1, name: 'Property Details.pdf', type: 'property_proof', uploadDate: '2023-11-01' },
      { id: 2, name: 'Salary Statements.pdf', type: 'salary_proof', uploadDate: '2023-11-01' },
    ],
    notes: 'Additional documents requested: Property valuation report and legal clearance certificate.',
    timeline: [
      { date: '2023-11-01T13:20:00', action: 'Application Submitted', actor: 'Morgan Lee' },
      { date: '2023-11-03T15:45:00', action: 'Initial Review Completed', actor: 'HR Team' },
      { date: '2023-11-05T11:30:00', action: 'Documentation Verification', actor: 'Finance Department' },
      { date: '2023-11-06T14:15:00', action: 'Additional Documentation Requested', actor: 'Finance Manager' },
    ]
  },
  'LN-2023-005': {
    id: 'LN-2023-005',
    ...
    amount: 30000,
    term: 2, // years
    purpose: 'Debt consolidation to simplify multiple ongoing loans and credit card payments.',
    repaymentMethod: 'Salary Deduction',
    ...
    documents: [
      { id: 1, name: 'Existing Loan Statements.pdf', type: 'debt_proof', uploadDate: '2023-10-28' },
      { id: 2, name: 'Credit Card Statements.pdf', type: 'debt_proof', uploadDate: '2023-10-28' },
      { id: 3, name: 'Salary Statement.pdf', type: 'salary_proof', uploadDate: '2023-10-28' },
    ],
    notes: 'Consolidating existing debts should improve financial stability.',
    timeline: [
      { date: '2023-10-28T11:15:00', action: 'Application Submitted', actor: 'Casey Brown' },
      { date: '2023-10-30T09:30:00', action: 'Documentation Verified', actor: 'HR Team' },
      { date: '2023-11-02T14:45:00', action: 'Financial Analysis Completed', actor: 'Finance Department' },
      { date: '2023-11-05T10:20:00', action: 'Application Approved', actor: 'Michael Wong' },
    ]
  }
};
...
export default function LoanApplicationDetailsPage() {
  ...
  const canApprove = role === 'admin' || role === 'hr_director' || role === 'finance_manager';
  ...
  const handleApprovalSubmit = async (e) => {
    ...
    try {
      ...
      const updatedApplication = {
        ...
        interestRate: approvalData.interestRate ? `${approvalData.interestRate}%` : undefined,
        notes: approvalData.approvalNotes || application?.notes,
        timeline: [
          ...application?.timeline || [],
          {
            date: new Date().toISOString(),
            action: approvalData.decision === 'approve' ? 'Application Approved' : 'Application Rejected',
    ...
    return (
      <>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-6">The loan application you're looking for doesn't exist or you don't have permission to view it.</p>
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Details for loan application ${application.id}`} />
      </Head>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {application.status === 'Approved' && (
              <Button 
                variant="outline"
                onClick={() => router.push(`/loans/repayment-schedule/${application.id}`)}
                className="flex items-center gap-2"
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{formatDate(application.joinDate)}</p>
                    </div>
                    <div>
                  ...
                  {application.status === 'Approved' && (
                    <div className="mt-4 pt-4 border-t">
                      <p className="text-xs text-gray-500 mb-2">Approval Information</p>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-xs text-gray-500">Approved By</p>
                          <p className="text-sm font-medium">{application.approvedBy}</p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-500">Approval Date</p>
                          <p className="text-sm font-medium">{formatDate(application.approvalDate)}</p>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">{application.term} {application.term === 1 ? 'year' : 'years'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500">Repayment Method</p>
                      <p className="text-sm font-medium">{application.repaymentMethod}</p>
                    </div>
                    ...
                    {application.interestRate && (
                      <>
                        <div>
                          ...
                          <p className="text-sm font-medium">{application.interestRate}</p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-500">Monthly Payment</p>
                          <p className="text-sm font-medium">₹{application.monthlyPayment.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                        </div>
                      </>
                    )}
                  </div>
                        ...
                        <div>
                          ...
                          <div className="mt-1">
                            ...
                            {errors.disbursementDate && (
                              <p className="text-red-500 text-sm mt-1">{errors.disbursementDate}</p>
                            )}
                          </div>
                        </div>
                      </>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center py-2 border-b">
                      ...
                      <p className="text-sm font-medium">₹{(application.monthlyPayment * application.term * 12).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      <p className="text-sm">Total Interest</p>
                      <p className="text-sm font-medium">₹{((application.monthlyPayment * application.term * 12) - application.amount).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    </div>
                  </div>
