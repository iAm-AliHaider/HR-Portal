...
export default function RepaymentScheduleListPage() {
      ...
      if (response.ok) {
        ...
        if (!isAdmin) {
          const userRepayments = mockRepayments.filter(
            (rep) =>
              rep.loan_applications?.employee_id === (user?.id || "EMP-001"),
          );
  ...
  const summaryStats = {
    ...
    paidInstallments: filteredRepayments.filter((r) => r.status === "paid")
      .length,
    pendingInstallments: filteredRepayments.filter(
      (r) => r.status === "pending",
    ).length,
    overdueInstallments: filteredRepayments.filter(
      (r) => r.status === "overdue",
    ).length,
    totalAmount: filteredRepayments.reduce((sum, r) => sum + r.amount, 0),
    paidAmount: filteredRepayments
  ...
  return (
    <ModernDashboardLayout>
      <Head>
        ...
        <meta
          name="description"
          content="View and manage loan repayment schedules"
        />
      </Head>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              {isAdmin
                ? "All Loan Repayment Schedules"
                : "My Loan Repayment Schedules"}
            </h1>
            <p className="text-gray-600 mt-1">
              {isAdmin
                ? "View and manage all employee loan repayments"
                : "View your loan repayment schedules and payment history"}
            </p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {summaryStats.totalInstallments}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-600">
                    {summaryStats.pendingInstallments}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">
                    {summaryStats.overdueInstallments}
                  </p>
                </div>
                      ...
                      <tr key={repayment.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              {repayment.loan_applications?.loan_type || "N/A"}
                            </div>
                          </div>
                        </td>
                        {isAdmin && (
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              of{" "}
                              {repayment.loan_applications?.term_months ||
                                "N/A"}{" "}
                              installments
                            </div>
                          </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              Principal: {formatCurrency(repayment.principal)} |
                              Interest: {formatCurrency(repayment.interest)}
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/loans/repayment-schedule/${repayment.loan_id}`,
                              )
                            }
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-blue-600">
                      {formatCurrency(
                        summaryStats.totalAmount - summaryStats.paidAmount,
                      )}
                    </span>
                  </div>
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Loan payments are automatically deducted from your
                        salary on the due date.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        You can make early payments without any prepayment
                        penalties. Contact HR for assistance.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Late payments may incur additional charges. Please
