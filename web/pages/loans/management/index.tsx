            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600">Review and manage employee loan applications</p>
                </div>
                <Button
              ...
              {isLoading ? (
                ...
                <Card>
                  <CardContent className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-4">There are currently no loan applications to review.</p>
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600">View and manage your personal loans</p>
                </div>
                <Button
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">{formatCurrency(loan.monthly_emi)}</p>
                          </div>
                          <div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1 mr-4">
                            <div className="flex justify-between text-sm mb-1">
                              ...
                              <span>{Math.round(((loan.amount - loan.remaining_balance) / loan.amount) * 100)}%</span>
                            </div>
                          ...
                          <div className="flex gap-2">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => router.push(`/loans/repayment-schedule/${loan.id}`)}
                            >
                              View Schedule
                            </Button>
                            <Button
