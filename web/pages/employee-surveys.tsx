  ...
  const surveys = [
    {
      ...
      createdBy: "HR Team",
      description:
        "Quarterly assessment of employee engagement, satisfaction, and organizational culture",
      questions: [
        {
          id: "q1",
          type: "rating",
    ...
    },
    {
      ...
      description:
        "Weekly pulse survey to assess remote work productivity and challenges",
      questions: [
        {
          id: "q1",
          type: "rating",
          question: "How productive were you working remotely this week?",
          required: true,
        },
        {
          id: "q2",
          type: "rating",
          question: "How well did you collaborate with your team?",
          required: true,
        },
        {
          id: "q3",
    ...
    },
    {
      ...
      description:
        "Comprehensive 360-degree feedback for management development",
      questions: [
        {
          id: "q1",
          type: "rating",
          question: "How effectively does this manager communicate?",
          required: true,
        },
        {
          id: "q2",
          type: "rating",
          question: "How well does this manager support your development?",
          required: true,
        },
        {
          id: "q3",
          type: "text",
          question: "What should this manager start doing?",
          required: false,
        },
        {
          id: "q4",
          type: "text",
          question: "What should this manager stop doing?",
          required: false,
        },
      ],
      avgScore: 4.0,
    ...
    },
    {
      ...
      description:
        "Assessment to identify training and development needs across the organization",
      questions: [
        {
          id: "q1",
          type: "multiple",
        ...
        },
        {
          id: "q2",
          type: "rating",
          question: "How confident are you in your current technical skills?",
          required: true,
        },
        {
          id: "q3",
  ...
  const responses = [
    {
      ...
      responses: [
        ...
        },
        {
          questionId: "q3",
          question: "What motivates you most at work?",
          answer: "Learning new technologies",
          type: "multiple",
        },
        {
          questionId: "q4",
          question: "What would improve your work experience?",
          answer: "More flexible hours and better equipment",
          type: "text",
        },
      ],
      overallScore: 4.5,
    ...
    },
    {
      ...
      responses: [
        ...
        },
        {
          questionId: "q3",
          question: "What motivates you most at work?",
          answer: "Commission and recognition",
          type: "multiple",
        },
        {
          questionId: "q4",
          question: "What would improve your work experience?",
          answer: "Better CRM tools and clearer targets",
          type: "text",
        },
      ],
      overallScore: 3.5,
              ...
              .map((survey) => (
                <div key={survey.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${getStatusColor(survey.status)}`}
                    >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                    ...
                    <div className="text-center">
                      <div
                        className={`text-lg font-bold ${getScoreColor(survey.avgScore)}`}
                      >
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold text-purple-600">
                        {survey.totalTargets - survey.responses}
                      </div>
              ...
              {analytics.engagementTrends.map((trend, index) => (
                <div key={index} className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`font-medium ${getScoreColor(trend.score)}`}
                    >
                      {trend.score}/5
                    </span>
            ...
            <div className="space-y-3">
              {analytics.departmentScores.map((dept, index) => (
                <div key={index} className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`font-medium ${getScoreColor(dept.score)}`}
                    >
                      {dept.score}/5
                    </span>
                    <div className="w-16 bg-gray-200 rounded-full h-2">
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <div>
                      ...
                      <span
                        className={`ml-1 ${getScoreColor(survey.avgScore)}`}
                      >
                        {survey.avgScore ? `${survey.avgScore}/5` : "N/A"}
                      </span>
                    </div>
              ...
              <tbody>
                {responses.map((response) => (
                  <tr key={response.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-4">
                      <span
                        className={`font-medium ${getScoreColor(response.overallScore)}`}
                      >
          ...
          <Card key={template.id}>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <span className="text-2xl mr-3">
                    {getSurveyTypeIcon(template.type)}
                  </span>
                  <div>
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs ${getStatusColor(template.status)}`}
                >
            ...
            <div className="space-y-4">
              <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-sm text-green-700">
                  Engineering team shows consistently high satisfaction scores
                  (4.5/5)
                </p>
              </div>
              ...
              <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-700">
                  Finance department has lower scores - focus on work-life
                  balance
                </p>
              </div>
              ...
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  Overall engagement increased 5% from last quarter
                </p>
              </div>
            </div>
          </CardContent>
              ...
              <tbody>
                {analytics.departmentScores.map((dept, index) => (
                  <tr key={index} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-4">
                      <span
                        className={`font-bold ${getScoreColor(dept.score)}`}
                      >
                        {dept.score}/5
                      </span>
                    </td>
                    ...
                    <td className="p-4">
                      <span
                        className={`text-xs ${Math.random() > 0.5 ? "text-green-600" : "text-red-600"}`}
                      >
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  <span className="text-4xl mr-4">
                    {getSurveyTypeIcon(selectedSurvey.type)}
                  </span>
                  <div>
                    ...
                    <p className="text-gray-600">
                      Created by {selectedSurvey.createdBy}
                    </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        <span
                          className={`ml-1 px-2 py-1 rounded-full text-xs ${getStatusColor(selectedSurvey.status)}`}
                        >
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        ...
                        <span
                          className={`ml-1 ${getScoreColor(selectedSurvey.avgScore)}`}
                        >
                          {selectedSurvey.avgScore
                            ? `${selectedSurvey.avgScore}/5`
                            : "N/A"}
                        </span>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-lg p-6 max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">
                  Survey Response - {selectedResponse.employeeName}
                </h2>
                <button
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        ...
                        {selectedResponse.completionTime} minutes
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-center">
                      <div
                        className={`text-4xl font-bold ${getScoreColor(selectedResponse.overallScore)}`}
                      >
                    ...
                    {selectedResponse.responses.map((resp, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {resp.type === "rating" ? (
                            <span
                              className={`font-medium ${getScoreColor(resp.answer)}`}
                            >
                              {resp.answer}/5
                            </span>
                          ) : (
        ...
        {showCreateSurvey && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              Create Survey Modal{" "}
              <button onClick={() => setShowCreateSurvey(false)}>Close</button>
            </div>
          </div>
        )}
        {showPulseSurvey && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              Pulse Survey Modal{" "}
              <button onClick={() => setShowPulseSurvey(false)}>Close</button>
            </div>
          </div>
        )}
        {showAnalytics && (
