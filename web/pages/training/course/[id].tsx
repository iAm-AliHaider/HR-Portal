...
const CourseDetailsPage = () => {
  ...
  const [enrollmentType, setEnrollmentType] = useState<
    "self_enrolled" | "manager_assigned"
  >("self_enrolled");
  ...
  const handleEnroll = async () => {
    ...
    try {
      ...
      const updatedEnrollments = await TrainingService.getEnrollments("org1", {
        course_id: course!.id,
      });
  ...
  const isEnrolled = enrollments.some(
    (e) => e.user_id === "current_user_id" && e.status !== "cancelled",
  );
  const completedEnrollment = enrollments.find(
    (e) => e.user_id === "current_user_id" && e.status === "completed",
  );
                        ...
                        <VStack spacing={4} align="stretch">
                          ...
                          {session.trainer && (
                            <HStack>
                              <Avatar
                                size="sm"
                                src={session.trainer.profile_image_url}
                                name={`${session.trainer.first_name} ${session.trainer.last_name}`}
                              />
                      ...
                      <CardBody>
                        <VStack spacing={4} align="stretch">
                          <HStack justify="space-between">
                            ...
                            <Badge
                              colorScheme={
                                assessment.is_mandatory ? "red" : "blue"
                              }
                            >
                ...
                {completedEnrollment && course.certification_awarded ? (
                  <VStack spacing={6} align="stretch">
                    <Alert status="success">
                      ...
                      <Box>
                        ...
                        <Text fontSize="sm">
                          You have successfully completed this course and earned
                          a certificate.
                        </Text>
                      </Box>
                    </Alert>
                    ...
                    <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
                      {certificates
                        .filter((cert) => cert.user_id === "current_user_id")
                        .map((certificate) => (
                          <Card
                            key={certificate.id}
                            border="1px solid"
                              ...
                              <VStack spacing={4} align="stretch">
                                ...
                                <VStack spacing={2} align="stretch">
                                  <HStack justify="space-between">
                                    ...
                                    <Text fontSize="sm" fontWeight="medium">
                                      {format(
                                        parseISO(certificate.issue_date),
                                        "PPP",
                                      )}
                                    </Text>
                                  </HStack>
                                  {certificate.expiry_date && (
                                    <HStack justify="space-between">
                                      ...
                                      <Text fontSize="sm" fontWeight="medium">
                                        {format(
                                          parseISO(certificate.expiry_date),
                                          "PPP",
                                        )}
                                      </Text>
                                    </HStack>
                  ...
                  <Alert status="info">
                    ...
                    <Box>
                      ...
                      <Text fontSize="sm">
                        Complete this course to earn a certificate of
                        completion.
                      </Text>
                    </Box>
                  </Alert>
                  ...
                  <Alert status="info">
                    ...
                    <Box>
                      ...
                      <Text fontSize="sm">
                        This course does not award a certificate upon
                        completion.
                      </Text>
                    </Box>
                  </Alert>
              ...
              <VStack spacing={6} align="stretch">
                    ...
                    {sessions
                      ...
                      .map((session) => (
                        <option key={session.id} value={session.id}>
                          {format(parseISO(session.start_time), "PPP p")} -{" "}
                          {session.title}
                          {session.current_enrollment >=
                            session.max_participants && " (Full)"}
                        </option>
                      ))}
                  </Select>
                </FormControl>
                ...
                <FormControl>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      setEnrollmentType(
                        e.target.value as "self_enrolled" | "manager_assigned",
                      )
                    }
                  >
                ...
                {course.cost_per_participant && (
                  <Alert status="info">
                    ...
                    <Box>
                      ...
                      <Text fontSize="sm">
                        ${course.cost_per_participant} per participant
                      </Text>
                    </Box>
                  </Alert>
                )}
