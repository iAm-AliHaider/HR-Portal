...
// Higher-order component to prevent redirects
const withoutRedirect = (Component: React.ComponentType<any>) => {
  const WithoutRedirect = (props: any) => {
    // Intercept router.push to prevent specific redirects
    const router = useRouter();
    const originalPush = router.push;
    
    useEffect(() => {
      // Override the router.push method to prevent redirection
      // @ts-ignore - we're intentionally overriding the method
      router.push = (url: string, ...args: any[]) => {
        console.log('Preventing redirect to:', url);
        // Don't redirect, just return a resolved promise
...
const LogsPage = () => {
  ...
  // Disabled all redirects by using the HOC
