...
export default function EditJobPage() {
  ...
  useEffect(() => {
    if (job) {
      ...
      form.setValue('closing_date', job.closing_date ? new Date(job.closing_date).toISOString().split('T')[0] : '');
    }
  }, [job]);
  ...
  return (
    <RequireRole allowed={['admin', 'hr', 'recruiter']}>
      ...
      <DashboardLayout title="Edit Job" subtitle={job.title}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      {form.errors.department && (
                        <p className="mt-1 text-sm text-red-600">{form.errors.department}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => form.setValue('salary_range', e.target.value)}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => form.setValue('closing_date', e.target.value)}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      You can use HTML for formatting. List items will be displayed as bullet points.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => form.setValue('benefits', e.target.value)}
                    ></textarea>
                    <p className="mt-1 text-xs text-gray-500">
                      You can use HTML for formatting. List items will be displayed as bullet points.
                    </p>
