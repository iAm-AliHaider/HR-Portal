...
export default function JobApplicationPage() {
  ...
  if (jobLoading) {
    return (
      <ModernRequireRole
        allowed={["employee", "manager", "candidate"]}
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    Take your time to fill out this application carefully. You
                    cannot edit it after submission.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div
                        className={`border ${!resumeFile ? "border-red-300" : "border-gray-300"} border-dashed rounded-md px-3 py-4`}
                      >
                  ...
                  <div className="mt-4">
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Cover Letter Text (Optional if uploading a file)
                    </label>
                    <textarea
                      ...
                      onChange={(e) =>
                        form.setValue("cover_letter", e.target.value)
                      }
                    ></textarea>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setValue("current_company", e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setValue("current_position", e.target.value)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setValue("availability_date", e.target.value)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        form.setValue("salary_expectation", e.target.value)
                      }
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setValue("linkedin_url", e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setValue("github_url", e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          form.setValue("portfolio_url", e.target.value)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          form.setValue("hear_about_us", e.target.value)
                        }
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          form.setValue("additional_info", e.target.value)
                        }
                      ></textarea>
                    </div>
                  </div>
