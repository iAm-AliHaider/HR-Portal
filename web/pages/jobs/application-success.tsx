          ...
          <Card>
            <CardContent className="pt-6 pb-6 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                ...
                information and get back to you soon. You'll receive an email
                confirmation with the details of your application.
              </p>
              ...
              <div className="bg-blue-50 p-4 rounded mb-6 max-w-2xl mx-auto text-left">
                ...
                <ol className="list-decimal pl-5 text-blue-700 space-y-1">
                  <li>
                    Our recruitment team will review your application (typically
