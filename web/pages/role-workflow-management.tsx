...
export default function RoleWorkflowManagementPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "roles" | "workflows" | "assignments" | "compliance"
  >("dashboard");
  ...
  const canManageRoles =
    hasAdminAccess || hasPermission("user_permissions", "manage_settings");
  const canManageWorkflows =
    hasAdminAccess || hasPermission("workflows", "manage_settings");
    ...
    try {
      ...
      const mockRoles: WorkflowRole[] = [
        ...
        },
        {
          ...
          name: "HR Manager",
          description:
            "Human resources management with employee workflow access",
      ...
      const mockWorkflowTemplates: WorkflowTemplate[] = [
        {
          ...
          description:
            "Multi-step approval process for organizational policies",
          category: "compliance",
        ...
        },
        {
          ...
          description:
            "Employee leave request approval with manager escalation",
          category: "hr",
      ...
      const allAssignments = mockRoles.flatMap(
        (role) => role.assignedWorkflows,
      );
    ...
    <div className="space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Manage role assignments and workflow permissions across the
          organization
        </p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Button
              ...
              onClick={() =>
                alert("Creating new role with workflow assignments...")
              }
            >
            ...
            <Button
              ...
              className="h-20 flex flex-col items-center justify-center"
              onClick={() =>
                alert("Generating role-workflow compliance report...")
              }
            >
              <span className="text-2xl mb-1">📊</span>
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 mb-6">
        <nav className="flex -mb-px">
          {["dashboard", "roles", "workflows", "assignments", "compliance"].map(
            (tab) => (
              <button
                key={tab}
