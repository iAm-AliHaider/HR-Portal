...
export default function LearningPortal() {
  ...
  const recommendedCourses = [
    {
      ...
      description:
        "Learn advanced patterns and best practices for React development.",
      thumbnail: "📚",
    ...
    },
    {
      ...
      description:
        "Develop the essential skills needed to lead teams effectively.",
      thumbnail: "📚",
    ...
    },
    {
      ...
      description:
        "Improve your communication skills in professional settings.",
      thumbnail: "📚",
  ...
  const inProgressCourses = [
    {
      ...
      description:
        "Learn the fundamentals of project management and deliver successful projects.",
      thumbnail: "📚",
  ...
  return (
    <ModernDashboardLayout
      ...
      subtitle="Develop your skills and advance your career"
    >
      <Head>
        <title>Learning Portal | HR Portal</title>
        <meta
          name="description"
          content="Explore courses and training opportunities"
        />
        <meta
          name="viewport"
      ...
      <div
        ref={pageRef}
        className="container px-4 sm:px-6 mx-auto py-6 space-y-6 max-w-full lg:max-w-7xl"
      >
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">
              Discover, learn, and grow your professional skills
            </p>
          </div>
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Skills assessment based on your completed courses and manager
              feedback
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <TabsContent value="certifications">
            {certifications.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  You don't have any certifications yet. Complete certified
                  courses to earn them.
                </p>
              </div>
            )}
          </TabsContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Structured learning programs to achieve your career goals
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Develop essential leadership skills for management roles
                    </p>
                  </div>
