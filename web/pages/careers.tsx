        ...
        setJobs([
          {
            ...
            requirements: 'At least 5 years of experience with modern JavaScript frameworks...',
          ...
          },
          {
            ...
            requirements: 'Portfolio showing UX/UI work and proficiency with design tools...',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta name="description" content="Explore career opportunities and join our amazing team" />
      </Head>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="#jobs" className="bg-white text-blue-600 px-8 py-3 rounded-md font-semibold hover:bg-gray-100">
              View Open Positions
            </Link>
            <Link href="/candidate/register" className="border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-blue-600">
              Create Account
            </Link>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">We offer more than just a job - we offer a career</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Work with cutting-edge technology and drive innovation in everything we do.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Collaborate with talented professionals who are passionate about their work.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Continuous learning and development to advance your career.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="jobs" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Find your perfect role and apply today</p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-400">Building amazing careers together</p>
          </div>
        </div>
      </footer>
    </div>
