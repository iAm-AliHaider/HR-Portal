...
export default function WorkplaceSafetyPage() {
  ...
  if (loading) {
    return (
      <DashboardLayout title="Workplace Safety">
  ...
  return (
    <DashboardLayout title="Workplace Safety" subtitle="Monitor and manage workplace safety incidents, checks, and equipment inspections">
      {/* Tabs */}
