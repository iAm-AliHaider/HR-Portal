...
export default function DevEntryPage() {
  ...
  const handleAccountSelect = async (account: MockAccount) => {
    try {
      ...
      setMessage(
        "An error occurred during login. Using direct navigation instead...",
      );
      setDirectLinks(true);
              ...
              <div className="flex">
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    Cookie/localStorage access is restricted in your browser.
            ...
            {directLinks ? (
              <div className="mt-8 p-4 bg-gray-100 rounded-lg">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Click on a link to log in directly without using localStorage
                </p>
                ...
                <div className="space-y-3">
                  {mockAccounts
                    .filter(
                      (account) =>
                        selectedFilter === "all" ||
                        getFilteredRoles(selectedFilter).includes(account.role),
                    )
                    .map((account) => (
                      <div
                        key={account.email}
