  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Configure notification preferences and settings"
        />
      </Head>
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "newApplications")
                    }
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Receive emails when new job applications are submitted
                    </p>
                  </div>
                </label>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "interviewScheduled")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "leaveRequests")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "expenseSubmissions")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Notifications for expense report submissions
                    </p>
                  </div>
                </label>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "systemUpdates")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "weeklyDigest")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Weekly summary of activities and tasks
                    </p>
                  </div>
                </label>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("email", "monthlyReports")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("inApp", "newApplications")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("inApp", "interviewReminders")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("inApp", "taskAssignments")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("inApp", "leaveApprovals")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Updates on leave request approvals
                    </p>
                  </div>
                </label>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("inApp", "expenseApprovals")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Updates on expense report approvals
                    </p>
                  </div>
                </label>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("inApp", "systemAlerts")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("sms", "interviewReminders")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange("sms", "leaveApprovals")
                    }
                    className="rounded border-gray-300 text-blue-600 mr-3"
                  />
                  <div>
                    <span className="text-sm font-medium">Leave Approvals</span>
                    <p className="text-xs text-gray-500">
                      SMS updates for leave request decisions
                    </p>
                  </div>
                </label>
              </div>
