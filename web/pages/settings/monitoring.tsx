...
import { AlertTriangle, Activity, Server, BarChart3, Eye, CheckCircle, XCircle, AlertCircle, RefreshCw } from 'lucide-react';
...
export default function MonitoringSettings() {
  ...
  const [settings, setSettings] = useState<MonitoringSettings>({
    ...
    performance: {
      ...
      performance_targets: [
        ...
        { metric: 'Throughput', threshold: 1000, unit: 'req/min', enabled: true }
      ]
    },
    health_checks: {
      database_check: true,
      ...
      external_service_checks: [
        { name: 'Email Service', endpoint: 'smtp.gmail.com:587', timeout: 5000, enabled: true, status: 'healthy', last_check: '2024-01-15T14:30:00Z' },
        { name: 'Payment Gateway', endpoint: 'api.stripe.com', timeout: 3000, enabled: true, status: 'healthy', last_check: '2024-01-15T14:29:45Z' },
        { name: 'File Storage', endpoint: 's3.amazonaws.com', timeout: 5000, enabled: false, status: 'unknown', last_check: 'Never' },
        { name: 'Auth Provider', endpoint: 'auth0.com', timeout: 3000, enabled: true, status: 'unhealthy', last_check: '2024-01-15T14:25:30Z' }
      ]
    },
    analytics: {
      user_analytics: true,
  ...
  const monitoringStatus = {
    logging: settings.logging.retention_days > 0 && settings.logging.level ? 'healthy' : 'warning',
    performance: settings.performance.monitoring_enabled && settings.performance.metrics_collection ? 'healthy' : 'error',
    health_checks: settings.health_checks.database_check && settings.health_checks.api_check ? 'healthy' : 'warning',
    analytics: settings.analytics.user_analytics || settings.analytics.performance_analytics ? 'healthy' : 'warning'
  };
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'healthy': return <Badge variant="solid" className="bg-green-100 text-green-800">Healthy</Badge>;
      case 'warning': return <Badge variant="outline" className="border-yellow-500 text-yellow-700">Warning</Badge>;
      case 'error': return <Badge variant="outline" className="border-red-500 text-red-700">Error</Badge>;
      case 'unhealthy': return <Badge variant="outline" className="border-red-500 text-red-700">Unhealthy</Badge>;
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need admin privileges to access monitoring settings.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={handleRefreshMetrics} variant="outline" className="flex items-center gap-2">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{systemMetrics.avg_response_time}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{systemMetrics.active_users.toLocaleString()}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{systemMetrics.error_rate}</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure logging levels and retention policies</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings({
                      ...settings,
                      logging: { ...settings.logging, retention_days: parseInt(e.target.value) }
                    })}
                  />
                  <p className="text-sm text-gray-600 mt-1">
                    Logs older than {settings.logging.retention_days} days will be automatically deleted
                  </p>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        logging: { ...settings.logging, external_logging: e.target.checked }
                      })}
                ...
                {settings.logging.external_logging && (
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        logging: { ...settings.logging, log_aggregation_service: e.target.value }
                      })}
                      className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Current logging activity and storage usage</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="border rounded-lg p-3">
                    <p className="text-sm font-medium text-gray-600">Avg Log Size</p>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-gray-600">User login successful</span>
                      <span className="text-gray-400">2m ago</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-blue-600">[DEBUG]</span>
                      <span className="text-gray-600">Database query executed</span>
                      <span className="text-gray-400">5m ago</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-red-600">[ERROR]</span>
                      <span className="text-gray-600">Failed to send email</span>
                ...
                <Button
                  ...
                  className="w-full"
                >
                  {testStatus.logging === 'testing' ? 'Testing...' : 'Test Logging'}
                </Button>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure performance metrics and alerting</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        performance: { ...settings.performance, monitoring_enabled: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        performance: { ...settings.performance, metrics_collection: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        performance: { ...settings.performance, alerting_enabled: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="border rounded-lg p-3">
                    ...
                    <p className="text-2xl font-bold text-orange-600">{systemMetrics.cpu_usage}</p>
                  </div>
                  <div className="border rounded-lg p-3">
                    <p className="text-sm font-medium text-gray-600">Memory Usage</p>
                    <p className="text-2xl font-bold text-red-600">{systemMetrics.memory_usage}</p>
                  </div>
                  <div className="border rounded-lg p-3">
                    <p className="text-sm font-medium text-gray-600">Disk Usage</p>
                    <p className="text-2xl font-bold text-green-600">{systemMetrics.disk_usage}</p>
                  </div>
                  <div className="border rounded-lg p-3">
                    <p className="text-sm font-medium text-gray-600">Total Requests</p>
                    <p className="text-2xl font-bold text-blue-600">{systemMetrics.total_requests.toLocaleString()}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {settings.performance.performance_targets.map((target, index) => (
                      ...
                      <div className="flex items-center gap-3">
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            ...
                            onChange={(e) => {
                              const updatedTargets = [...settings.performance.performance_targets];
                              updatedTargets[index] = { ...target, enabled: e.target.checked };
                              setSettings({
                                ...settings,
                                performance: { ...settings.performance, performance_targets: updatedTargets }
                              });
                            }}
                            className="sr-only peer"
                          />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            const updatedTargets = [...settings.performance.performance_targets];
                            updatedTargets[index] = { ...target, threshold: parseFloat(e.target.value) };
                            setSettings({
                              ...settings,
                              performance: { ...settings.performance, performance_targets: updatedTargets }
                            });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure internal system health monitoring</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        health_checks: { ...settings.health_checks, database_check: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        health_checks: { ...settings.health_checks, api_check: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        health_checks: { ...settings.health_checks, storage_check: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <Button
                  ...
                  className="w-full"
                >
                  {testStatus['health-checks'] === 'testing' ? 'Testing...' : 'Run Health Checks'}
                </Button>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monitor external service dependencies</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {settings.health_checks.external_service_checks.map((service, index) => (
                    <div key={index} className="border rounded-lg p-3">
                        ...
                        <div className="flex items-center gap-3">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={(e) => {
                                const updatedServices = [...settings.health_checks.external_service_checks];
                                updatedServices[index] = { ...service, enabled: e.target.checked };
                                setSettings({
                                  ...settings,
                                  health_checks: { ...settings.health_checks, external_service_checks: updatedServices }
                                });
                              }}
                              className="sr-only peer"
                            />
                      ...
                      <p className="text-sm text-gray-600 mb-2">{service.endpoint}</p>
                      <div className="flex items-center justify-between text-xs text-gray-500">
                        <span>Timeout: {service.timeout}ms</span>
                        <span>Last check: {service.last_check === 'Never' ? 'Never' : new Date(service.last_check).toLocaleString()}</span>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure data collection and analytics tracking</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        analytics: { ...settings.analytics, user_analytics: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        analytics: { ...settings.analytics, performance_analytics: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex items-center space-x-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setSettings({
                        ...settings,
                        analytics: { ...settings.analytics, business_analytics: e.target.checked }
                      })}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div>
                  <Label htmlFor="analytics-retention">Data Retention (Days)</Label>
                  <Input
                    ...
                    onChange={(e) => setSettings({
                      ...settings,
                      analytics: { ...settings.analytics, retention_days: parseInt(e.target.value) }
                    })}
                  />
                  <p className="text-sm text-gray-600 mt-1">
                    Analytics data retention: {Math.floor(settings.analytics.retention_days / 365)} year(s)
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Current analytics data collection status</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="border rounded-lg p-3">
                  ...
                  <div className="border rounded-lg p-3">
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {[settings.analytics.user_analytics, settings.analytics.performance_analytics, settings.analytics.business_analytics].filter(Boolean).length}
                    </p>
                  </div>
                  <div className="border rounded-lg p-3">
                ...
                <Button
                  ...
                  className="w-full"
                >
                  {testStatus.analytics === 'testing' ? 'Testing...' : 'Test Analytics'}
                </Button>
              </CardContent>
            </Card>
          </div>
