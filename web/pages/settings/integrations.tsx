...
const IntegrationsSettingsPage = () => {
  ...
  const [settings, setSettings] = useState<IntegrationSettings>({
    email: {
      ...
      from_name: 'HR Portal',
      templates: [
        { id: '1', name: 'Welcome Email', subject: 'Welcome to our company!', type: 'welcome', enabled: true },
        { id: '2', name: 'Password Reset', subject: 'Reset your password', type: 'password_reset', enabled: true },
        { id: '3', name: 'Leave Approval', subject: 'Leave request update', type: 'leave_approval', enabled: true }
      ],
      enabled: true
    },
    calendar: {
  ...
  const integrationStatus = {
    email: { connected: true, last_test: '2024-01-20T09:00:00Z', messages_sent: 156 },
    calendar: { connected: false, last_test: null, events_synced: 0 },
    payroll: { connected: false, last_test: null, records_synced: 0 },
    storage: { connected: true, last_test: '2024-01-20T08:30:00Z', files_stored: 1245 },
    sso: { connected: false, last_test: null, users_authenticated: 0 }
  };

  // Handle settings update
  const updateSetting = (category: keyof IntegrationSettings, field: string, value: any) => {
    setSettings(prev => ({
      ...prev,
      [category]: {
        ...prev[category],
  ...
  const updateNestedSetting = (category: keyof IntegrationSettings, parent: string, field: string, value: any) => {
    setSettings(prev => ({
      ...prev,
      [category]: {
        ...prev[category],
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need administrator privileges to access integration settings.</p>
        </div>
      </div>
    );
  }
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">{integrationStatus.calendar.events_synced} events</p>
                    </div>
                  </div>
                  <div className={`h-3 w-3 rounded-full ${integrationStatus.calendar.connected ? 'bg-green-500' : 'bg-red-500'}`} />
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">{integrationStatus.payroll.records_synced} records</p>
                    </div>
                  </div>
                  <div className={`h-3 w-3 rounded-full ${integrationStatus.payroll.connected ? 'bg-green-500' : 'bg-red-500'}`} />
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">{integrationStatus.storage.files_stored} files</p>
                    </div>
                  </div>
                  <div className={`h-3 w-3 rounded-full ${integrationStatus.storage.connected ? 'bg-green-500' : 'bg-red-500'}`} />
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-xs text-gray-500">{integrationStatus.sso.users_authenticated} users</p>
                    </div>
                  </div>
                  <div className={`h-3 w-3 rounded-full ${integrationStatus.sso.connected ? 'bg-green-500' : 'bg-red-500'}`} />
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="lg:col-span-3">
            <Tabs value={activeTab} defaultValue="email">
              <TabsList className="grid w-full grid-cols-6">
                ...
                <TabsTrigger value="storage" onClick={() => setActiveTab('storage')}>Storage</TabsTrigger>
                <TabsTrigger value="sso" onClick={() => setActiveTab('sso')}>SSO</TabsTrigger>
                <TabsTrigger value="webhooks" onClick={() => setActiveTab('webhooks')}>Webhooks</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="email">
                <Card>
                  ...
                  <div className="flex items-center space-x-2">
                        ...
                        />
                        <label htmlFor="email_enabled" className="text-sm text-gray-900">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Password/API Key</label>
                          ...
                          <div key={template.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-md">
                            <div className="flex items-center space-x-3">
                              <input
                                ...
                                onChange={(e) => {
                                  const updatedTemplates = settings.email.templates.map(t =>
                                    t.id === template.id ? { ...t, enabled: e.target.checked } : t
                                  );
                                  updateSetting('email', 'templates', updatedTemplates);
                                }}
                                className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                              />
                              <div>
                            ...
                            <Badge variant={template.enabled ? 'solid' : 'outline'}>
                  ...
                  <CardFooter>
                    ...
                    >
                      ...
                      {testResults.email === 'testing' ? 'Testing...' : 'Test Connection'}
                    </Button>
                    {testResults.email && testResults.email !== 'testing' && (
                      <span className={`ml-4 text-sm ${testResults.email === 'success' ? 'text-green-600' : 'text-red-600'}`}>
                        {testResults.email === 'success' ? '✓ Connection successful' : '✗ Connection failed'}
                      </span>
                    )}
                  </CardFooter>
                </Card>
              ...
              <TabsContent value="calendar">
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>Sync events with external calendar services</CardDescription>
                      </div>
                      <div className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          ...
                          onChange={(e) => updateSetting('calendar', 'enabled', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="calendar_enabled" className="text-sm text-gray-900">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => updateSetting('calendar', 'provider', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            type={showPasswords.calendar_api ? 'text' : 'password'}
                            value={settings.calendar.api_key}
                            onChange={(e) => updateSetting('calendar', 'api_key', e.target.value)}
                            className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="Enter API key"
                          />
                  <button
                  ...
                  >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('calendar', 'default_calendar', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="primary"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('calendar', 'webhook_url', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={(e) => updateSetting('calendar', 'sync_enabled', e.target.checked)}
                        className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                  ...
                  <CardFooter>
                    ...
                    >
                      <RefreshCw className="h-4 w-4 mr-2" />
                      {testResults.calendar === 'testing' ? 'Testing...' : 'Test Connection'}
                    </Button>
                  </CardFooter>
                </Card>
              </TabsContent>
              ...
              <TabsContent value="payroll">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Connect with payroll systems for automated data sync</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center py-8">
                      <DollarSign className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                      <p className="text-gray-500">Payroll integration configuration will be available here.</p>
              ...
              <TabsContent value="storage">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Configure cloud storage for file management</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center py-8">
                      <Cloud className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                      <p className="text-gray-500">Storage integration configuration will be available here.</p>
                      <p className="text-sm text-gray-400 mt-2">Coming soon...</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">SSO configuration will be available here.</p>
                      <p className="text-sm text-gray-400 mt-2">Coming soon...</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">Webhook configuration will be available here.</p>
                      <p className="text-sm text-gray-400 mt-2">Coming soon...</p>
                    </div>
                  </CardContent>
                </Card>
