...
const PermissionsManagePage = () => {
  ...
  const [selectedPermission, setSelectedPermission] =
    useState<CustomPermission | null>(null);
  ...
  const loadData = async () => {
    try {
      ...
      const enhancedPermissions: CustomPermission[] = permissionsData.map(
        (p) => ({
          ...p,
  ...
  const modules = Array.from(
    new Set(permissions.map((p) => p.module || "core")),
  );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Create and manage system permissions"
        />
      </Head>
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Create and manage system permissions and access controls
            </p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">
                  {permissions.filter((p) => p.isCustom).length}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">
                  {permissions.filter((p) => p.is_sensitive).length}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="xl:col-span-2">
              {isCreating ? (
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900">
                          {selectedPermission.module || "core"}
                        </p>
                      </div>
                  ...
                  {selectedPermission.dependencies &&
                  ...
                  <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
                    ...
                    <p className="text-sm text-yellow-700">
                      This permission can be assigned to roles in the Role
                      Management interface. Use it to control access to specific
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  <div className="text-gray-400">
                    ...
                    <p className="text-gray-500 mb-4">
                      Choose a permission from the list to view its details and
                      configuration.
                    </p>
                    <PermissionButton
                      resource="user_permissions"
