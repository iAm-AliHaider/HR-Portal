...
const mockWorkflows = [
  {
    ...
    requestType: 'leave',
    steps: [
      { id: 'step-1', name: 'Initial Submission', approverType: 'System', estimatedTime: '1 day', isRequired: true },
      { id: 'step-2', name: 'Manager Approval', approverType: 'Manager', estimatedTime: '2 days', isRequired: true },
      { id: 'step-3', name: 'HR Verification', approverType: 'HR', estimatedTime: '1 day', isRequired: true }
    ]
  },
  {
    ...
    steps: [
      { id: 'step-1', name: 'Initial Submission', approverType: 'System', estimatedTime: '1 day', isRequired: true },
      { id: 'step-2', name: 'Manager Approval', approverType: 'Manager', estimatedTime: '2 days', isRequired: true },
      { id: 'step-3', name: 'IT Department Approval', approverType: 'IT Department', estimatedTime: '3 days', isRequired: true },
      { id: 'step-4', name: 'Procurement Processing', approverType: 'Procurement', estimatedTime: '5 days', isRequired: false }
    ]
  },
  {
    id: 'expense-workflow',
    ...
    steps: [
      { id: 'step-1', name: 'Initial Submission', approverType: 'System', estimatedTime: '1 day', isRequired: true },
      { id: 'step-2', name: 'Manager Approval', approverType: 'Manager', estimatedTime: '2 days', isRequired: true },
      { id: 'step-3', name: 'Finance Department Review', approverType: 'Finance Department', estimatedTime: '3 days', isRequired: true },
      { id: 'step-4', name: 'Payment Processing', approverType: 'Finance Department', estimatedTime: '2 days', isRequired: true }
    ]
  }
];
...
export default function WorkflowManager() {
  ...
  const { isOpen: isWorkflowDialogOpen, onOpen: openWorkflowDialog, onClose: closeWorkflowDialog } = useDisclosure();
  const { isOpen: isStepDialogOpen, onOpen: openStepDialog, onClose: closeStepDialog } = useDisclosure();
  ...
  return (
    <ModernDashboardLayout title="Workflow Manager" subtitle="Configure approval workflows for requests">
      <div className="container mx-auto px-4 py-6 space-y-8">
              ...
              <SimpleTableBody>
                {workflows.map((workflow) => (
                  <SimpleTableRow key={workflow.id}>
                    <SimpleTableCell className="font-medium">{workflow.name}</SimpleTableCell>
                    <SimpleTableCell>{workflow.requestType}</SimpleTableCell>
                    <SimpleTableCell>{workflow.steps.length}</SimpleTableCell>
                    <SimpleTableCell className="max-w-xs truncate">{workflow.description}</SimpleTableCell>
                ...
                {workflows.length === 0 && (
                  <SimpleTableRow>
                    <SimpleTableCell colSpan={5} className="text-center py-8 text-gray-500">
        ...
        <Dialog isOpen={isWorkflowDialogOpen} onClose={closeWorkflowDialog}>
          <DialogContent className="max-w-3xl">
              ...
              <div>
                ...
                {formData.steps.length > 0 ? (
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              ...
                              {step.estimatedTime && <span> • Est. time: {step.estimatedTime}</span>}
                  ...
                  <div className="border border-dashed rounded-md p-8 text-center text-gray-500">
                    ...
                    <p className="text-sm">Click "Add Step" to define the approval flow</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <DialogFooter className="mt-6">
              <Button variant="outline" onClick={closeWorkflowDialog}>Cancel</Button>
        ...
        <Dialog isOpen={isStepDialogOpen} onClose={closeStepDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{editingStep !== null ? 'Edit Step' : 'Add Step'}</DialogTitle>
              <DialogDescription>
                {editingStep !== null 
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setStepFormData({ ...stepFormData, approverType: value })}
                >
                  <SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="isRequired" className="text-sm font-medium">Required Step</label>
              </div>
            </div>
            
            <DialogFooter className="mt-6">
              <Button variant="outline" onClick={closeStepDialog}>Cancel</Button>
