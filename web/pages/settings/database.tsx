...
const DatabaseSettingsPage = () => {
  ...
  const recentActivity = [
    { time: '2024-01-20T10:30:00Z', event: 'Database backup completed', status: 'success' },
    { time: '2024-01-20T09:15:00Z', event: 'Performance optimization started', status: 'info' },
    { time: '2024-01-20T08:00:00Z', event: 'Daily health check passed', status: 'success' },
    { time: '2024-01-19T23:45:00Z', event: 'Slow query detected: users table scan', status: 'warning' }
  ];

  // Handle settings update
  const updateSetting = (category: keyof DatabaseSettings, field: string, value: any) => {
    setSettings(prev => ({
      ...prev,
      [category]: {
        ...prev[category],
  ...
  const updateNestedSetting = (category: keyof DatabaseSettings, parent: string, field: string, value: any) => {
    setSettings(prev => ({
      ...prev,
      [category]: {
        ...prev[category],
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need administrator privileges to access database settings.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">Manage database connections, backups, and performance</p>
              </div>
            </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{connectionStats.active_connections}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{connectionStats.total_queries_today.toLocaleString()}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{connectionStats.avg_response_time}ms</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{connectionStats.cache_hit_ratio}%</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{connectionStats.storage_used}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{connectionStats.storage_available}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="lg:col-span-3">
            <Tabs value={activeTab} defaultValue="connection">
              <TabsList className="grid w-full grid-cols-4">
                <TabsTrigger value="connection" onClick={() => setActiveTab('connection')}>Connection</TabsTrigger>
                ...
                <TabsTrigger value="monitoring" onClick={() => setActiveTab('monitoring')}>Monitoring</TabsTrigger>
              </TabsList>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('connection', 'host', e.target.value)}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('connection', 'database', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('connection', 'pool_size', parseInt(e.target.value))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="10"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('connection', 'max_connections', parseInt(e.target.value))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="100"
                        />
                      </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={(e) => updateSetting('connection', 'ssl', e.target.checked)}
              ...
              <TabsContent value="backup">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Manage database backup settings and schedule</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center">
                      <input
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="md:col-span-2">
                            ...
                            <input
                              ...
                              onChange={(e) => updateSetting('backup', 'storage_location', e.target.value)}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        {settings.backup.last_backup && (
                          <div className="bg-green-50 p-3 rounded-md">
                            <p className="text-sm text-green-800">
                              Last backup: {new Date(settings.backup.last_backup).toLocaleString()}
                            </p>
                          </div>
                        )}
                      </>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="cache_enabled" className="ml-2 block text-sm text-gray-900">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => updateSetting('performance', 'index_optimization', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="index_optimization" className="ml-2 block text-sm text-gray-900">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('performance', 'slow_query_threshold', parseInt(e.target.value))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="1000"
                        />
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => updateSetting('monitoring', 'slow_query_log', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="slow_query_log" className="ml-2 block text-sm text-gray-900">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => updateSetting('monitoring', 'performance_metrics', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="performance_metrics" className="ml-2 block text-sm text-gray-900">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => updateSetting('monitoring', 'error_tracking', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="error_tracking" className="ml-2 block text-sm text-gray-900">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => updateSetting('monitoring', 'health_checks', e.target.checked)}
                          className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="health_checks" className="ml-2 block text-sm text-gray-900">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            type="number"
                            value={settings.monitoring.alert_thresholds.cpu_usage}
                            onChange={(e) => updateNestedSetting('monitoring', 'alert_thresholds', 'cpu_usage', parseInt(e.target.value))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="80"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            type="number"
                            value={settings.monitoring.alert_thresholds.memory_usage}
                            onChange={(e) => updateNestedSetting('monitoring', 'alert_thresholds', 'memory_usage', parseInt(e.target.value))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="85"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">Connection Count (%)</label>
                          <input
                            type="number"
                            value={settings.monitoring.alert_thresholds.connection_count}
                            onChange={(e) => updateNestedSetting('monitoring', 'alert_thresholds', 'connection_count', parseInt(e.target.value))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="90"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            type="number"
                            value={settings.monitoring.alert_thresholds.response_time}
                            onChange={(e) => updateNestedSetting('monitoring', 'alert_thresholds', 'response_time', parseInt(e.target.value))}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="2000"
                          />
                        </div>
