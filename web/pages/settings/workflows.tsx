...
interface WorkflowAction {
  id: string;
  type: 'email' | 'slack' | 'webhook' | 'update_field' | 'create_task' | 'assign_user';
...
const WorkflowManagementPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'builder' | 'settings' | 'analytics'>('overview');
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedType, setSelectedType] = useState<string>('all');
  const [selectedStatus, setSelectedStatus] = useState<string>('all');

  // Check if user has permission to manage workflows
  const canManageWorkflows = hasPermission('workflows', 'manage_settings') || hasPermission('system_settings', 'update');
      ...
      const mockWorkflows: Workflow[] = [
        {
          ...
          description: 'Comprehensive leave request approval workflow with escalation',
          type: 'leave',
          status: 'active',
          version: 2,
          enabled: true,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Create and manage business process workflows" />
      </Head>
      ...
      <div className="p-4 md:p-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{workflows.filter(w => w.status === 'active').length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{workflows.reduce((sum, w) => sum + w.usage_count, 0)}</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">
                  {Math.round(workflows.reduce((sum, w) => sum + (w.avg_completion_time || 0), 0) / workflows.length)}h
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <Button 
            ...
            onClick={() => alert('Creating new workflow with role assignments...')}
          >
        ...
        <div className="border-t pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-600 mb-3">Leave approval, onboarding, performance reviews</p>
              <div className="flex gap-2">
                <Button size="sm" onClick={() => alert('Creating HR workflow template...')}>
                  Create
                </Button>
                <Button size="sm" variant="outline" onClick={() => alert('Browsing HR templates...')}>
                  Browse
                </Button>
              </div>
            </div>
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <h4 className="font-medium text-green-800 mb-2">Compliance Workflows</h4>
              <p className="text-sm text-green-600 mb-3">Policy approval, audit processes, training assignments</p>
              <div className="flex gap-2">
                <Button size="sm" onClick={() => alert('Creating compliance workflow...')}>
                  Create
                </Button>
                <Button size="sm" variant="outline" onClick={() => alert('Viewing compliance templates...')}>
                  Browse
                </Button>
              </div>
            </div>
            ...
            <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <h4 className="font-medium text-purple-800 mb-2">Finance Workflows</h4>
              <p className="text-sm text-purple-600 mb-3">Expense approval, budget planning, procurement</p>
              <div className="flex gap-2">
                <Button size="sm" onClick={() => alert('Creating finance workflow...')}>
                  Create
                </Button>
                <Button size="sm" variant="outline" onClick={() => alert('Exploring finance templates...')}>
                  Browse
                </Button>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-lg font-semibold">Workflows ({filteredWorkflows.length})</h2>
                </div>
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-1">
                            ...
                            <span className={`inline-flex px-1.5 py-0.5 text-xs font-semibold rounded ${getTypeColor(workflow.type)}`}>
                              {workflow.type}
                            </span>
                          </div>
                          <p className="text-xs text-gray-500 mb-2">{workflow.description}</p>
                          <div className="flex items-center justify-between">
                            <span className={`inline-flex px-1.5 py-0.5 text-xs font-semibold rounded ${getStatusColor(workflow.status)}`}>
                              {workflow.status}
                            </span>
                        ...
                        <PermissionGuard permissions={['workflows.delete', 'system_settings.update']}>
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
              ...
              {selectedWorkflow ? (
                    ...
                    {activeTab === 'overview' && (
                      <div className="space-y-6">
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="flex items-center space-x-3 mb-2">
                              ...
                              <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded ${getTypeColor(selectedWorkflow.type)}`}>
                                {selectedWorkflow.type}
                              </span>
                              <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded ${getStatusColor(selectedWorkflow.status)}`}>
                          ...
                          <div className="flex space-x-2">
                            <PermissionButton
                              permissions={['workflows.update', 'system_settings.update']}
                              ...
                              <div key={step.id} className="bg-gray-50 p-4 rounded-lg">
                                <div className="flex items-center space-x-3 mb-2">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500">{step.description || `${step.type} step`}</p>
                                  </div>
                                </div>
                                <div className="flex items-center justify-between text-xs text-gray-500">
                                  <span>Assigned to: {step.assignee}</span>
                                  {step.timeLimit && <span>Timeout: {step.timeLimit}h</span>}
                                </div>
                              </div>
                            ))}
                          </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="bg-blue-50 p-4 rounded-lg">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <p className="text-sm font-medium text-blue-600">Usage Count</p>
                                <p className="text-lg font-semibold text-blue-900">{selectedWorkflow.usage_count}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-green-50 p-4 rounded-lg">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                ...
                                <p className="text-lg font-semibold text-green-900">{selectedWorkflow.avg_completion_time?.toFixed(1)}h</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-purple-50 p-4 rounded-lg">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <p className="text-sm font-medium text-purple-600">Version</p>
                                <p className="text-lg font-semibold text-purple-900">v{selectedWorkflow.version}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        {selectedWorkflow.policies.length > 0 && (
                          <div>
                            <h3 className="text-lg font-medium text-gray-900 mb-3">Associated Policies</h3>
                            <div className="flex flex-wrap gap-2">
                              {selectedWorkflow.policies.map((policyId) => (
                                <span key={policyId} className="inline-flex px-3 py-1 text-sm font-medium rounded-full bg-red-100 text-red-800">
                                  {policyId.replace('policy_', '').replace('_', ' ').toUpperCase()}
                                </span>
                              ))}
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {selectedWorkflow.integrations.map((integration) => (
                                <div key={integration.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                  <div className={`w-3 h-3 rounded-full ${integration.enabled ? 'bg-green-500' : 'bg-red-500'}`} />
                                  <div>
                    ...
                    {activeTab === 'builder' && (
                      <div className="text-center py-12">
                        <div className="text-gray-400">
                          ...
                          <h3 className="text-xl font-medium mb-2">Workflow Builder</h3>
                    ...
                    {activeTab === 'settings' && (
                      <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-900">{selectedWorkflow.type}</p>
                              </div>
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <p className="text-sm text-gray-900">v{selectedWorkflow.version}</p>
                              </div>
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-900">{new Date(selectedWorkflow.updated_at).toLocaleDateString()}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        {selectedWorkflow.variables.length > 0 && (
                          <div>
                            <h3 className="text-lg font-medium text-gray-900 mb-4">Workflow Variables</h3>
                    ...
                    {activeTab === 'analytics' && (
                      <div className="text-center py-12">
                        <div className="text-gray-400">
                          ...
                          <h3 className="text-xl font-medium mb-2">Workflow Analytics</h3>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  <div className="text-gray-400">
                    ...
                    <h3 className="text-xl font-medium mb-2">Select a workflow to view details</h3>
                    <p className="text-gray-500 mb-4">Choose a workflow from the list to view its configuration and analytics.</p>
                    <PermissionButton
                      permissions={['workflows.create', 'system_settings.update']}
                      onClick={handleCreateWorkflow}
