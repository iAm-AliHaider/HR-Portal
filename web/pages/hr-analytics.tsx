...
export default function HRAnalyticsPage() {
  ...
  const tabs: Tab[] = [
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Monthly Headcount Trends</h3>
                <div className="h-64 flex items-center justify-center bg-gray-100 rounded">
                  <p className="text-gray-500">Headcount trend chart will be displayed here</p>
                </div>
              </div>
              
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Headcount by Location</h3>
                <div className="h-64 flex items-center justify-center bg-gray-100 rounded">
                  <p className="text-gray-500">Headcount by location chart will be displayed here</p>
                </div>
              </div>
            </div>
          </CardContent>
    ...
    },
    {
      ...
      content: (
        <Card>
          <CardContent className="pt-6">
            <h2 className="text-xl font-bold mb-4">Turnover & Retention Analytics</h2>
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Average Tenure</h3>
                  <div className="text-center">
                    <div className="text-5xl font-bold text-green-600 mb-2">3.7</div>
                    <p className="text-sm text-gray-500">Years of service (average)</p>
                  </div>
                </div>
              </div>
              
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Exit Reasons Analysis</h3>
                <div className="h-64 flex items-center justify-center bg-gray-100 rounded">
  ...
  return (
    <ModernDashboardLayout title="HR Analytics" subtitle="Comprehensive HR analytics and insights">
