  ...
  employees: [
    {
      ...
      deductions: {
        health_insurance: { enabled: true, amount: 285.00 },
        dental_insurance: { enabled: true, amount: 45.00 },
        retirement_401k: { enabled: true, percentage: 10.0 },
        life_insurance: { enabled: true, amount: 12.00 }
      },
      banking_info: {
  ...
  pay_stubs: [
    {
      ...
      deductions: {
        ...
        medicare: 64.20,
        health_insurance: 142.50,
        dental_insurance: 22.50,
...
async function handleGet(req: NextApiRequest, res: NextApiResponse) {
  ...
  switch (type) {
    ...
    case 'paystubs':
      ...
      if (period_id) {
        payStubs = payStubs.filter(stub => stub.payroll_period_id === period_id);
      }
      if (id) {
