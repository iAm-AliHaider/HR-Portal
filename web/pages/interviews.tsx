...
const InterviewsPage = () => {
  ...
  const filteredInterviews = interviews.filter((interview) => {
    const application = applications.find(
      (app) => app.id === interview.application_id,
    );
            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem
                  icon={<ViewIcon />}
                  onClick={() =>
                    router.push(`/applications/${interview.application_id}`)
                  }
                >
                  View Application
                </MenuItem>
                ...
                <MenuItem icon={<EditIcon />}>Reschedule</MenuItem>
              </MenuList>
            </Menu>
          </Flex>
        </CardHeader>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage interview scheduling and feedback"
        />
      </Head>
                ...
                <VStack spacing={4}>
                  <Box width="100%">
                    ...
                    <Text fontSize="sm" color="gray.500">
                      Candidate:{" "}
                      {
                        getApplication(selectedInterview.application_id)
                          ?.candidate?.full_name
                      }
                    </Text>
                  </Box>
