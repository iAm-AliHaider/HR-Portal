  ...
  const workflows = [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          id: 4,
          name: "Brand Guidelines Training",
          duration: "1 day",
              ...
              .map((hire) => (
                <div key={hire.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${getStatusColor(hire.status)}`}
                    >
                  ...
                  <div className="flex justify-between items-center text-sm text-gray-600">
                    <span>
                      Tasks: {hire.tasksCompleted}/{hire.totalTasks}
                    </span>
                    <span>
                      Documents: {hire.documents.completed}/
                      {hire.documents.total}
                    </span>
                ...
                >
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      {workflow.department} • {workflow.duration}
                    </div>
                  </div>
                ...
                {onboardingTasks.map((task) => (
                  <tr key={task.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-4">
                      ...
                      <div className="text-sm text-gray-600">
                        {
                          newHires.find((h) => h.id === task.employeeId)
                            ?.department
                        }
                      </div>
                    </td>
          ...
          <Card key={buddy.id}>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs ${getStatusColor(buddy.status)}`}
                >
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex justify-between text-sm">
                  <span>Meetings:</span>
                  <span className="font-medium">
                    {buddy.meetingsCompleted}/{buddy.meetingsScheduled}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>Next Meeting:</span>
                  <span className="font-medium">
                    {new Date(buddy.nextMeeting).toLocaleDateString()}
                  </span>
                </div>
              </div>
      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Streamline new employee onboarding with workflows and tracking
          </p>
        </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div>
                        ...
                        {selectedEmployee.documents.completed}/
                        {selectedEmployee.documents.total}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      <div className="text-lg font-bold text-orange-600">
                        {selectedEmployee.documents.pending}
                      </div>
        ...
        {showAddHire && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              Add New Hire Modal{" "}
              <button onClick={() => setShowAddHire(false)}>Close</button>
            </div>
          </div>
        )}
        {showWorkflow && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              ...
              <button onClick={() => setShowWorkflow(false)}>Close</button>
            </div>
          </div>
        )}
        {showBuddy && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-8 rounded shadow">
              Assign Buddy Modal{" "}
              <button onClick={() => setShowBuddy(false)}>Close</button>
            </div>
          </div>
        )}
        {showReports && (
