...
const AssetFormModal = ({
  ...
  useEffect(() => {
    if (asset) {
      setFormData({
        ...
        booking_rules: {
          ...
          advance_booking_hours:
            asset.booking_rules?.advance_booking_hours || 24,
      ...
      const specsArray = Object.entries(asset.specifications || {}).map(
        ([key, value]) => ({
          key,
          value: String(value),
        }),
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...
                    booking_rules: {
                      ...prev.booking_rules,
                      max_duration_hours: parseInt(e.target.value) || 0,
                    },
                  }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...
                    booking_rules: {
                      ...prev.booking_rules,
                      checkout_required: e.target.checked,
                    },
                  }))
                }
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage equipment inventory and asset tracking"
        />
      </Head>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Manage equipment, assets, and inventory tracking
              </p>
            </div>
            <button
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                      <div className="flex space-x-2">
                        ...
                        <span
                          className={`px-2 py-1 text-xs rounded-full ${getConditionColor(asset.condition)}`}
                        >
                          {conditionOptions.find(
                            (opt) => opt.value === asset.condition,
                      ...
                      <button
                        onClick={() =>
                          router.push(`/bookings?asset=${asset.id}`)
                        }
                        className="text-blue-600 hover:text-blue-800 text-sm font-medium"
                      >
                        View Bookings →
