...
const MOCK_TEAMS: EnhancedTeam[] = [
  {
    ...
    description:
      "Core development team responsible for product engineering and technical innovation",
    status: "active",
  },
  {
    id: "team2",
    ...
    description:
      "Dynamic sales team focused on revenue growth and customer acquisition",
    status: "active",
  },
  {
    id: "team3",
    ...
    description:
      "Creative marketing team driving brand awareness and customer engagement",
    status: "active",
  },
  {
    id: "team4",
    ...
    description:
      "People operations team ensuring employee satisfaction and organizational growth",
    status: "active",
  },
  {
    id: "team5",
    ...
    description:
      "Product strategy and design team shaping user experience and product direction",
    status: "forming",
  },
];
...
const TeamsPage = () => {
  ...
  const stats = {
    ...
    avgPerformance: Math.round(
      teams.reduce((sum, team) => sum + (team.performance_score || 0), 0) /
        teams.length,
    ),
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive team management and organization system"
        />
      </Head>
      ...
      <ModernDashboardLayout>
        ...
        <Modal isOpen={isTeamOpen} onClose={onTeamClose} size="4xl">
          <ModalOverlay />
          <ModalContent>
            <ModalHeader>{selectedTeam?.name} - Team Details</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
              {selectedTeam && (
                    ...
                    <Stat textAlign="center">
                      ...
                      <StatNumber
                        color={getPerformanceColor(
                          selectedTeam.performance_score || 0,
                        )}
                      >
                    ...
                    <Box>
                      ...
                      <VStack spacing={2} align="stretch">
                        ...
                        <Flex justify="space-between">
                          ...
                          <Badge
                            colorScheme={getStatusColor(selectedTeam.status)}
                            variant="subtle"
                          >
                            {selectedTeam.status}
                          </Badge>
            ...
            <ModalFooter>
              <ButtonGroup spacing={2}>
                ...
                <Button colorScheme="blue">Edit Team</Button>
              </ButtonGroup>
            </ModalFooter>
          </ModalContent>
        </Modal>
