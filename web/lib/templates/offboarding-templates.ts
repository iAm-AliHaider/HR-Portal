...
export const DEFAULT_OFFBOARDING_TEMPLATES: Partial<OffboardingTemplate>[] = [
    ...
    task_templates: [
      {
        ...
        description:
          "Formally acknowledge receipt of resignation and confirm last working day",
        category: "hr",
        priority: "critical",
        assigned_to_role: "hr",
        ...
        instructions:
          "Send acknowledgment email confirming receipt, last day, and next steps",
        auto_assign: true,
      },
      {
        title: "Schedule Exit Interview",
        description:
          "Schedule comprehensive exit interview with departing employee",
        category: "hr",
        priority: "high",
        assigned_to_role: "hr",
      ...
      },
      {
        ...
        due_day_offset: 1,
        instructions:
          "Coordinate with manager on communication strategy and timing",
      },
      {
        title: "Create Knowledge Transfer Plan",
        description:
          "Develop comprehensive plan for knowledge transfer and documentation",
        category: "manager",
        priority: "critical",
        assigned_to_role: "manager",
        due_day_offset: 2,
        instructions:
          "Identify key knowledge areas, select transfer recipients, create timeline",
      },
      {
        title: "Document Current Projects and Responsibilities",
        description:
          "Create detailed documentation of all current projects and ongoing responsibilities",
        category: "employee",
        priority: "critical",
        ...
        instructions:
          "Document all active projects, deadlines, contacts, and handover requirements",
      },
      {
      ...
      },
      {
        ...
        instructions:
          "Conduct thorough handover sessions with each project successor",
      },
      {
        title: "Calculate Final Pay and Benefits",
        description:
          "Calculate final paycheck including unused vacation and benefits",
        category: "hr",
        priority: "critical",
        assigned_to_role: "hr",
        due_day_offset: -5,
        ...
        instructions:
          "Calculate final pay, vacation payout, and provide benefits continuation info",
      },
      {
        ...
        due_day_offset: -5,
        instructions:
          "List all assigned equipment: laptop, phone, access cards, keys, etc.",
      },
      {
        ...
        due_day_offset: -3,
        instructions:
          "Prepare access removal checklist - DO NOT EXECUTE until last day",
      },
      {
      ...
      },
      {
        ...
        description:
          "Communicate departure to relevant departments and stakeholders",
        category: "manager",
        priority: "medium",
        assigned_to_role: "manager",
        due_day_offset: -3,
        instructions:
          "Send professional announcement to relevant teams and external contacts",
      },
      {
        ...
        dependencies: [5], // After successors identified
        instructions:
          "Coordinate client communications and introduce new points of contact",
      },
      {
        ...
        due_day_offset: -1,
        instructions:
          "Remove from org charts, update directories, reassign responsibilities",
      },
      {
      ...
      },
      {
        ...
        instructions:
          "Deactivate all accounts, remove access permissions, update security groups",
      },
      {
      ...
      },
      {
        ...
        due_day_offset: 3,
        instructions:
          "Archive personnel file, update HRIS status, retain records per policy",
      },
      {
        title: "Prepare Reference Letter",
        description:
          "Prepare standard reference letter for future employment verification",
        category: "hr",
        priority: "low",
        assigned_to_role: "hr",
        due_day_offset: 5,
        ...
        instructions:
          "Prepare neutral reference letter based on performance and exit interview",
      },
    ],
    checklist_items: [
      {
  ...
  },
  {
    ...
    description:
      "Specialized offboarding for software engineers and technical roles",
    ...
    task_templates: [
      {
        ...
        description:
          "Review and document all code repositories and access permissions",
        category: "it",
        priority: "critical",
        assigned_to_role: "it",
        due_day_offset: -7,
        instructions:
          "Document all GitHub, GitLab, and internal repository access",
      },
      {
        title: "Technical Documentation Handover",
        description:
          "Complete technical documentation for all systems and projects",
        category: "employee",
        priority: "critical",
        assigned_to_role: "employee",
        due_day_offset: -10,
        ...
        instructions:
          "Document system architecture, APIs, deployment processes, and known issues",
      },
      {
        title: "Code Review and Knowledge Transfer",
        description:
          "Conduct code reviews and technical knowledge transfer sessions",
        category: "employee",
        priority: "critical",
        assigned_to_role: "employee",
        due_day_offset: -5,
        ...
        instructions:
          "Review critical code sections with team members, explain complex implementations",
      },
      {
        ...
        due_day_offset: -3,
        instructions:
          "Plan removal of production database, server, and deployment access",
      },
      {
        ...
        due_day_offset: -2,
        instructions:
          "Remove personal scripts, clean up development environments, commit pending work",
      },
      {
        title: "Security Key and Certificate Handover",
        description:
          "Transfer or revoke security keys, certificates, and tokens",
        category: "it",
        priority: "critical",
        assigned_to_role: "it",
        due_day_offset: 0,
        instructions:
          "Revoke API keys, SSL certificates, SSH keys, and authentication tokens",
      },
      {
        title: "Technical Mentor Assignment",
        description:
          "Assign technical mentors for ongoing support of transferred projects",
        category: "manager",
        priority: "high",
        assigned_to_role: "manager",
        due_day_offset: -5,
        instructions:
          "Identify team members to serve as ongoing technical contacts for transferred work",
      },
    ],
    checklist_items: [
      {
  ...
  },
  {
    ...
    description:
      "Specialized offboarding process for managers and team leaders",
    department_id: null,
    job_role: "manager",
    reason_for_leaving: "resignation",
    is_default: false,
    ...
    task_templates: [
      {
        ...
        description:
          "Develop comprehensive plan for team leadership transition",
        category: "manager",
        priority: "critical",
        assigned_to_role: "manager",
        due_day_offset: -14,
        instructions:
          "Identify interim leadership, plan team communication, address ongoing projects",
      },
      {
        title: "Direct Report Transition Meetings",
        description:
          "Hold individual meetings with each direct report about transition",
        category: "manager",
        priority: "critical",
        assigned_to_role: "manager",
        due_day_offset: -10,
        ...
        instructions:
          "Meet with each team member individually to discuss transition and address concerns",
      },
      {
        title: "Performance Review Documentation",
        description:
          "Complete performance reviews and development plans for all direct reports",
        category: "manager",
        priority: "high",
        assigned_to_role: "manager",
        due_day_offset: -12,
        ...
        instructions:
          "Ensure all team member performance documentation is current and comprehensive",
      },
      {
        ...
        due_day_offset: -7,
        instructions:
          "Handover budget management, vendor relationships, and resource allocation responsibilities",
      },
      {
        title: "Strategic Project Briefing",
        description:
          "Brief successor on strategic initiatives and long-term projects",
        category: "manager",
        priority: "critical",
        assigned_to_role: "manager",
        due_day_offset: -5,
        instructions:
          "Provide detailed briefing on strategic initiatives, project roadmaps, and key objectives",
      },
      {
        ...
        instructions:
          "Communicate with key internal and external stakeholders about leadership transition",
      },
      {
        title: "Team Announcement and Q&A",
        description:
          "Hold team meeting to announce departure and address questions",
        category: "manager",
        priority: "high",
        assigned_to_role: "manager",
        due_day_offset: -2,
        instructions:
          "Conduct team meeting to announce departure, introduce interim leadership, and address concerns",
      },
      {
        title: "Management System Access Transfer",
        description:
          "Transfer management system access and administrative permissions",
        category: "hr",
        priority: "critical",
        assigned_to_role: "hr",
        due_day_offset: 0,
        instructions:
          "Transfer HRIS access, performance management systems, and administrative permissions",
      },
    ],
    checklist_items: [
      {
  ...
  },
  {
    ...
    description:
      "Structured process for involuntary terminations and dismissals",
    ...
    task_templates: [
      {
        ...
        approval_required: true,
        instructions:
          "Ensure all documentation is complete and compliant with employment law",
      },
      {
        ...
        due_day_offset: 0,
        instructions:
          "Prepare to immediately disable all access upon termination notification",
      },
      {
        ...
        due_day_offset: 0,
        instructions:
          "Conduct professional termination meeting with witness present",
      },
      {
        ...
        auto_assign: true,
        instructions:
          "Immediately disable all accounts, revoke access cards, and secure systems",
      },
      {
        ...
        due_day_offset: 0,
        instructions:
          "Collect laptop, phone, keys, access cards, and any other company property",
      },
      {
        ...
        approval_required: true,
        instructions:
          "Calculate final pay per state law, process within required timeframe",
      },
      {
        ...
        due_day_offset: 3,
        instructions:
          "Mail COBRA election notice and benefits termination information",
      },
      {
        ...
        due_day_offset: 5,
        instructions:
          "Update HRIS, remove from directories, update organizational charts",
      },
    ],
    checklist_items: [
      {
  ...
  },
  {
    ...
    description:
      "Special process for employee retirements with celebration and knowledge preservation",
    ...
    task_templates: [
      {
        ...
        description:
          "Schedule consultation with benefits specialist for retirement planning",
        category: "hr",
        priority: "critical",
        assigned_to_role: "hr",
        due_day_offset: -30,
        instructions:
          "Connect with benefits provider for retirement plan distribution options",
      },
      {
        ...
        instructions:
          "Create comprehensive documentation of career accomplishments and knowledge",
      },
      {
        title: "Mentorship Transition",
        description:
          "Transition mentorship relationships and identify successors",
        category: "employee",
        priority: "high",
        assigned_to_role: "employee",
        due_day_offset: -14,
        instructions:
          "Transition mentorship relationships and identify team members to continue guidance",
      },
      {
        ...
        due_day_offset: -10,
        instructions:
          "Plan appropriate retirement celebration recognizing years of service",
      },
      {
        title: "Knowledge Preservation Video",
        description:
          "Record video interview preserving institutional knowledge",
        category: "hr",
        priority: "medium",
        assigned_to_role: "hr",
        due_day_offset: -7,
        instructions:
          "Record interview about career highlights, lessons learned, and advice for successors",
      },
      {
        title: "Retiree Contact Information",
        description:
          "Collect contact information for alumni network and future consultation",
        category: "hr",
        priority: "low",
        assigned_to_role: "hr",
        due_day_offset: -3,
        instructions:
          "Collect updated contact information and preferences for future communication",
      },
    ],
    checklist_items: [
      {
