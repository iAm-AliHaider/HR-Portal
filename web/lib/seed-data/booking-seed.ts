...
export const sampleMeetingRooms: Partial<MeetingRoom>[] = [
  {
    ...
    description:
      "Large conference room perfect for board meetings and presentations",
  ...
  },
  {
    ...
    description:
      "Medium-sized meeting room ideal for team meetings and interviews",
  ...
  },
  {
    ...
    description:
      "Large training room equipped for workshops and training sessions",
...
export const sampleAssets: Partial<Asset>[] = [
  {
    ...
    description:
      "High-performance laptop for presentations and development work",
    category: "laptop",
    brand: "Apple",
  ...
  },
  {
    ...
    description:
      "Professional cinema camera for video recording and live streaming",
    category: "camera",
    brand: "Sony",
    model: "FX3",
  ...
  },
  {
    ...
    description:
      "Professional broadcast microphone for podcasts and recordings",
    category: "microphone",
    brand: "Shure",
    model: "SM7B",
  ...
  },
  {
    ...
    description:
      "Mobile whiteboard with markers and erasers for brainstorming sessions",
    category: "whiteboard",
    brand: "Quartet",
  ...
  },
  {
    ...
    description:
      "Professional portable audio recorder for interviews and meetings",
    category: "recording",
    brand: "Zoom",
...
export const sampleRoomBookings: Partial<RoomBooking>[] = [
  ...
  },
  {
    ...
    setup_requirements:
      "Classroom style seating, laptops for each participant, presentation setup",
...
export const sampleAssetBookings: Partial<AssetBooking>[] = [
  {
    ...
    notes:
      "High priority project - laptop contains specialized design software",
  },
  {
  ...
  },
  {
    ...
    checkout_notes:
      "Includes tripod, extra batteries, memory cards, and lens kit",
  ...
  },
  {
    ...
    checkout_notes:
      "Includes Apple Pencil, Magic Keyboard, and presentation app",
  ...
  },
  {
    ...
    checkout_notes:
      "Includes external microphones, windscreens, and memory cards",
