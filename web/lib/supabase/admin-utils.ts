  ...
  getUploadTemplates(): UploadTemplate[] {
    return [
      // Core User & Employee Management
      {
        ...
        columns: ['id', 'email', 'name', 'role', 'department', 'position', 'avatar_url', 'phone', 'address', 'date_of_birth', 'hire_date', 'employee_id', 'manager_id'],
      ...
      },
      {
        ...
        columns: ['id', 'profile_id', 'employee_id', 'first_name', 'last_name', 'email', 'phone', 'address', 'department', 'position', 'salary', 'hire_date', 'status', 'manager_id'],
        requiredFields: ['employee_id', 'first_name', 'last_name', 'email', 'department', 'position'],
        sampleData: [
          {
            employee_id: 'EMP001',
            first_name: 'John',
      ...
      },
      {
        ...
        columns: ['id', 'name', 'description', 'manager_id', 'budget', 'location', 'created_at'],
        requiredFields: ['name'],
        sampleData: [
          {
            name: 'Engineering',
      ...
      },
      {
        ...
        columns: ['id', 'employee_id', 'skill_id', 'proficiency_level', 'created_at'],
      ...
      // Leave Management
      {
        ...
        columns: ['id', 'name', 'description', 'default_days', 'requires_approval', 'color', 'created_at'],
        requiredFields: ['name'],
        sampleData: [
          {
            name: 'Annual Leave',
      ...
      },
      {
        ...
        columns: ['id', 'employee_id', 'leave_type_id', 'year', 'allocated_days', 'used_days', 'pending_days'],
        requiredFields: ['employee_id', 'leave_type_id', 'year', 'allocated_days'],
        sampleData: [
          {
            employee_id: 'user-123',
      ...
      },
      {
        ...
        columns: ['id', 'employee_id', 'leave_type_id', 'start_date', 'end_date', 'days', 'status', 'reason', 'approver_id'],
        requiredFields: ['employee_id', 'leave_type_id', 'start_date', 'end_date', 'days'],
        sampleData: [
          {
            employee_id: 'user-123',
            leave_type_id: 'leave-type-456',
      ...
      },
      {
        ...
        columns: ['id', 'title', 'description', 'category', 'duration', 'instructor', 'status', 'max_participants', 'location', 'start_date', 'end_date'],
      ...
      },
      {
        ...
        columns: ['id', 'employee_id', 'course_id', 'status', 'completion_date', 'score', 'feedback'],
      ...
      // Recruitment & Hiring
      {
        ...
        columns: ['id', 'title', 'department', 'location', 'description', 'requirements', 'salary_range', 'employment_type', 'status', 'hiring_manager_id'],
      ...
      },
      {
        ...
        columns: ['id', 'job_id', 'candidate_name', 'email', 'phone', 'resume_url', 'cover_letter_url', 'status', 'source'],
      ...
      },
      {
        ...
        columns: ['id', 'application_id', 'interviewer_id', 'scheduled_at', 'duration', 'location', 'interview_type', 'status', 'feedback', 'rating'],
      ...
      },
      {
        ...
        columns: ['id', 'application_id', 'salary', 'start_date', 'benefits', 'status', 'offered_at', 'expires_at'],
      ...
      // Loan Management
      {
        ...
        columns: ['id', 'name', 'description', 'max_amount', 'interest_rate', 'max_term_months', 'minimum_service_months', 'status'],
        requiredFields: ['name', 'max_amount', 'interest_rate', 'max_term_months'],
        sampleData: [
          {
            name: 'Emergency Loan',
      ...
      },
      {
        ...
        columns: ['id', 'employee_id', 'program_id', 'amount', 'term_months', 'purpose', 'status', 'approver_id'],
      ...
      },
      {
        ...
        columns: ['id', 'loan_id', 'amount', 'due_date', 'payment_date', 'status'],
      ...
      },
      {
        ...
        columns: ['id', 'room_id', 'employee_id', 'title', 'start_time', 'end_time', 'attendees', 'status'],
        requiredFields: ['room_id', 'employee_id', 'title', 'start_time', 'end_time'],
        sampleData: [
          {
            room_id: 'room-123',
      ...
      },
      {
        ...
        columns: ['id', 'name', 'category', 'serial_number', 'purchase_date', 'condition', 'location', 'assigned_to', 'status'],
        requiredFields: ['name', 'category'],
        sampleData: [
          {
            name: 'MacBook Pro 16"',
      ...
      },
      {
        ...
        columns: ['id', 'equipment_id', 'employee_id', 'purpose', 'checkout_time', 'expected_return_time', 'actual_return_time', 'status'],
      ...
      },
      {
        ...
        columns: ['id', 'category_id', 'name', 'description', 'form_schema', 'requires_approval', 'approver_role', 'sla_hours'],
        ...
        sampleData: [
          {
            ...
            form_schema: '{"software_name": "string", "business_justification": "text"}',
            requires_approval: true,
      ...
      },
      {
        ...
        columns: ['id', 'request_type_id', 'employee_id', 'title', 'description', 'form_data', 'status', 'priority', 'assignee_id'],
        ...
        sampleData: [
          {
            ...
            form_data: '{"software_name": "Adobe Photoshop", "business_justification": "Design tasks"}',
            status: 'pending',
            priority: 'normal'
          }
        ]
      ...
      // Safety & Compliance
      {
        ...
        columns: ['id', 'reporter_id', 'incident_date', 'location', 'description', 'severity', 'witnesses', 'status', 'resolution'],
        requiredFields: ['reporter_id', 'incident_date', 'location', 'description', 'severity'],
        sampleData: [
          {
      ...
      },
      {
        ...
        columns: ['id', 'equipment_name', 'location', 'inspector_id', 'check_date', 'status', 'notes', 'next_check_date'],
        requiredFields: ['equipment_name', 'location', 'inspector_id', 'check_date', 'status'],
        sampleData: [
          {
      ...
      },
      {
        ...
        columns: ['id', 'title', 'due_date', 'status', 'assigned_to', 'location', 'frequency', 'priority'],
      ...
      },
      {
        ...
        columns: ['id', 'equipment_name', 'inspection_type', 'last_inspection', 'next_due_date', 'status', 'assigned_to', 'location', 'notes'],
        requiredFields: ['equipment_name', 'inspection_type', 'last_inspection', 'next_due_date', 'status'],
        sampleData: [
          {
      ...
      // Financial & Expense Management
      {
        ...
        columns: ['id', 'name', 'description', 'code', 'requires_receipt', 'max_amount'],
      ...
      },
      {
        ...
        columns: ['id', 'employee_id', 'title', 'total_amount', 'currency', 'status', 'submitted_date', 'approved_date', 'approver_id'],
      ...
      },
      {
        ...
        columns: ['id', 'report_id', 'category_id', 'description', 'amount', 'date', 'receipt_url', 'notes'],
        requiredFields: ['report_id', 'category_id', 'description', 'amount', 'date'],
        sampleData: [
          {
      ...
      // Performance & Reviews
      {
        ...
        columns: ['id', 'employee_id', 'reviewer_id', 'review_period', 'overall_rating', 'goals', 'feedback', 'status', 'reviewed_date'],
        requiredFields: ['employee_id', 'reviewer_id', 'review_period', 'overall_rating'],
        sampleData: [
          {
            employee_id: 'user-123',
      ...
      // Workflow & Compliance
      {
        ...
        columns: ['id', 'name', 'description', 'type', 'steps', 'status', 'created_by'],
        ...
        sampleData: [
          {
            ...
            type: 'onboarding',
            steps: '["HR Introduction", "IT Setup", "Department Tour", "Training Assignment"]',
            status: 'active'
          }
        ]
      },
      {
        ...
        columns: ['id', 'workflow_id', 'employee_id', 'current_step', 'status', 'started_at', 'completed_at'],
      ...
      },
      {
        ...
        columns: ['id', 'title', 'description', 'category', 'frequency', 'responsible_role', 'due_date', 'status'],
      ...
      },
      {
        ...
        columns: ['id', 'title', 'type', 'auditor', 'audit_date', 'findings', 'recommendations', 'status'],
      ...
      // System & Configuration
      {
        ...
        columns: ['id', 'name', 'industry', 'size', 'address', 'phone', 'email', 'website', 'timezone', 'currency'],
        requiredFields: ['name'],
        sampleData: [
          {
            name: 'Tech Corp Inc.',
      ...
      },
      {
        ...
        columns: ['id', 'recipient_id', 'title', 'message', 'type', 'category', 'is_read', 'created_at'],
      ...
      },
      {
        ...
        columns: ['id', 'title', 'description', 'category_id', 'file_url', 'file_name', 'file_size', 'uploaded_by', 'access_level'],
