...
export async function getAttendance(org_id: string, user_id?: string): Promise<Attendance[]> {
...
export async function createAttendance(record: Partial<Attendance>): Promise<Attendance> {
