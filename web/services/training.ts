...
export const getTrainingCategories = async (orgId: string): Promise<TrainingCategory[]> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const createTrainingCategory = async (category: Omit<TrainingCategory, 'id' | 'created_at' | 'updated_at'>): Promise<TrainingCategory> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const getTrainingCourse = async (courseId: string): Promise<EnhancedTrainingCourse | null> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const createTrainingCourse = async (course: Omit<TrainingCourse, 'id' | 'created_at' | 'updated_at'>): Promise<TrainingCourse> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const updateTrainingCourse = async (courseId: string, updates: Partial<TrainingCourse>): Promise<TrainingCourse> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const getTrainer = async (trainerId: string): Promise<Trainer | null> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const createTrainer = async (trainer: Omit<Trainer, 'id' | 'created_at' | 'updated_at'>): Promise<Trainer> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
...
export const updateTrainer = async (trainerId: string, updates: Partial<Trainer>): Promise<Trainer> => {
  if (!isSupabaseConfigured()) {
    throw new Error('Database not configured. Please check your environment settings.');
  }
