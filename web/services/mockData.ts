...
export const mockJobs = [
  ...
  },
  {
    ...
    description:
      "Create amazing user experiences for our web and mobile applications.",
...
export const mockOffers = [
  {
    ...
    notes:
      "Candidate accepted offer and signed contract. Starting on October 15th.",
  ...
  },
  {
    ...
    contract_type: "full-time",
    notes:
      "Candidate rejected offer due to compensation. Accepted a competitive offer.",
  ...
  },
  {
    ...
    contract_type: "full-time",
    notes:
      "Candidate requested salary adjustment and additional equity. HR is considering the request.",
