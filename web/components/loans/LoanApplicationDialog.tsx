...
const LOAN_TYPES: LoanType[] = [
  {
    ...
    max_term_months: 60,
    min_term_months: 6,
    eligibility_criteria: 'All permanent employees with minimum 6 months tenure'
  },
  {
    id: 'education',
    name: 'Education Loan',
    ...
    max_term_months: 120,
    min_term_months: 12,
    eligibility_criteria: 'Employees with minimum 2 years tenure and valid educational documents'
  },
  {
    id: 'emergency',
    name: 'Emergency Loan',
    ...
    max_term_months: 24,
    min_term_months: 3,
    eligibility_criteria: 'All employees eligible, faster processing for urgent needs'
  }
];
...
export default function LoanApplicationDialog({ isOpen, onClose, onSuccess }: LoanApplicationDialogProps) {
  ...
  const handleSubmit = async () => {
    try {
      const submissionData = {
        employee_id: applicationData.employment_details.employee_id || 'EMP-001',
          ...
          <React.Fragment key={step}>
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs mt-1 text-gray-600 hidden sm:block">
                {step === 1 ? 'Type' : step === 2 ? 'Details' : step === 3 ? 'Employment' : 'Review'}
              </span>
            </div>
            {step < 4 && (
              <div className={`flex-1 h-1 mx-2 rounded ${currentStep > step ? 'bg-blue-600' : 'bg-gray-200'}`} />
            )}
          </React.Fragment>
        ))}
      </div>
  ...
  const renderStepOne = () => (
    <div className="space-y-4">
      <div className="text-center mb-6">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Choose Your Loan Type</h3>
        <p className="text-gray-600 text-sm sm:text-base">Select the loan that best fits your needs</p>
      </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-900 mb-1">{loanType.name}</h4>
                  <p className="text-sm text-gray-600 mb-2">{loanType.description}</p>
                </div>
  ...
  const renderStepTwo = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Loan Details</h3>
        <p className="text-gray-600 text-sm sm:text-base">Enter your loan requirements</p>
      </div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">{selectedLoanType?.name}</h4>
              <p className="text-sm text-gray-600">{selectedLoanType?.description}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Range: {formatCurrency(selectedLoanType?.min_amount || 0)} - {formatCurrency(selectedLoanType?.max_amount || 0)}
            </p>
          </div>
            ...
            <Card className="bg-green-50 border-green-200">
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                  <p className="text-2xl sm:text-3xl font-bold text-green-600">{formatCurrency(calculatedEMI)}</p>
  ...
  const renderStepThree = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Employment Details</h3>
        <p className="text-gray-600 text-sm sm:text-base">Verify your employment information</p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                Employment details will be verified with HR records. Please ensure accuracy.
              </p>
            </div>
          </div>
        </CardContent>
  ...
  const renderStepFour = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Review & Submit</h3>
        <p className="text-gray-600 text-sm sm:text-base">Please review your application details</p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  <span className="text-gray-500">Amount:</span>
                  <p className="font-medium text-green-600">{formatCurrency(parseFloat(applicationData.amount) || 0)}</p>
                </div>
                <div>
                  <span className="text-gray-500">Term:</span>
              ...
              <div className="pt-2 border-t">
                ...
                <p className="font-medium text-sm mt-1">{applicationData.purpose}</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-start space-x-3">
                ...
                <label htmlFor="declaration" className="text-sm text-gray-700">
                  <strong className="text-red-800">Declaration:</strong> I declare that all information provided is true and accurate. I agree to the terms and conditions.
                </label>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-sm">Application will be processed within 2-3 days.</p>
                </div>
              </div>
            </div>
          )}
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1: return selectedLoanType;
      case 2: return applicationData.amount && applicationData.term_months && applicationData.purpose;
      case 3: return applicationData.employment_details.employee_id && 
      ...
      case 4: return applicationData.declaration;
      ...
      <DialogContent className="w-[95vw] max-w-4xl max-h-[95vh] overflow-hidden bg-white rounded-xl shadow-xl">
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Apply for Employee Loan</h2>
              <p className="text-sm text-gray-600 hidden sm:block">Complete your application in simple steps</p>
            </div>
          </div>
          <button
            onClick={onClose}
