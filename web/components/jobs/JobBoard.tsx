...
const JobBoard = ({ orgId }: { orgId: string }) => {
  ...
  const {
    isOpen: isArchiveJobOpen,
    onOpen: onArchiveJobOpen,
    onClose: onArchiveJobClose,
  } = useDisclosure();
  ...
  const filteredJobs = jobs
    .filter((job) => {
      ...
      const matchesDepartment =
        filterDepartment === "all" || job.dept_id === filterDepartment;
      const matchesCategory =
        filterCategory === "all" || job.category_id === filterCategory;
      const matchesStatus =
        ...
        <Container maxW="full" py={6}>
          ...
          <SimpleGrid columns={{ base: 2, md: 3, lg: 6 }} spacing={4} mb={6}>
            ...
            >
              ...
              <StatNumber fontSize="xl" color="gray.500">
                {stats.draft}
              </StatNumber>
            </Stat>
            <Stat
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Alert status="warning" mb={4}>
              ...
              <AlertDescription>
                The job will be marked as closed and candidates won't be able to
                apply anymore.
              </AlertDescription>
            </Alert>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Alert status="warning" mb={4}>
              ...
              <AlertDescription>
                Archived jobs are hidden from the main list and can be restored
                later if needed.
              </AlertDescription>
            </Alert>
