...
export default function JobFilters({
  ...
  const handleCheckboxChange = (
    filterType: "departments" | "locations" | "types",
    value: string,
  ) => {
                  ...
                  {departments.map((department) => (
                    <div key={department.id} className="flex items-center">
                      <input
                        ...
                        onChange={() =>
                          handleCheckboxChange("departments", department.id)
                        }
                      />
                      <label
                  ...
                  {locations.map((location) => (
                    <div key={location.id} className="flex items-center">
                      <input
                        ...
                        onChange={() =>
                          handleCheckboxChange("locations", location.id)
                        }
                      />
                      <label
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4">
            ...
            {filters.departments.map((dept) => {
              ...
              return (
                <div
                  key={`dept-${dept}`}
                  className="bg-blue-50 text-blue-800 text-xs px-2 py-1 rounded-full flex items-center"
                >
                  {label}
                  <button
            ...
            {filters.locations.map((loc) => {
              ...
              return (
                <div
                  key={`loc-${loc}`}
                  className="bg-green-50 text-green-800 text-xs px-2 py-1 rounded-full flex items-center"
                >
                  {label}
                  <button
            ...
            {filters.types.map((type) => {
              ...
              return (
                <div
                  key={`type-${type}`}
                  className="bg-purple-50 text-purple-800 text-xs px-2 py-1 rounded-full flex items-center"
                >
                  {label}
                  <button
