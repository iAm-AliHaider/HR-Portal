...
const TabGroup: React.FC<TabGroupProps> = ({
  ...
  const variantStyles = {
    underline: {
      ...
      tab: {
        default: 'py-2 px-4 text-gray-500 hover:text-gray-700 border-b-2 border-transparent',
    ...
    buttons: {
      ...
      tab: {
        default: 'py-2 px-4 text-gray-500 hover:text-gray-700 first:rounded-l-md last:rounded-r-md border-r border-gray-200 last:border-r-0',
  ...
  return (
    <div className={cn('w-full', vertical && 'sm:flex sm:space-x-8', className)}>
      {/* Tab List */}
      <div className={cn(
