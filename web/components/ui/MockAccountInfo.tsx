...
export const mockAccounts: MockAccount[] = [
  ...
  // Recruitment Team
  {
    ...
    description:
      "Manages recruitment processes, job postings, and hiring decisions",
  },
  {
    ...
    department: "Talent Acquisition",
    description:
      "Handles job postings, candidate screening, and interview scheduling",
  },
  ...
  // Department Managers
  {
    ...
    description:
      "Manages engineering team, approves leave, and conducts performance reviews",
  },
  {
    ...
    department: "Sales",
    description:
      "Manages sales team, approves expenses, and handles department resources",
  },
  {
    ...
    department: "Finance",
    description:
      "Manages finance team, approves budgets, and handles department reports",
  },
  ...
  // Team Leads
  {
    ...
    department: "Engineering",
    description:
      "Leads development team, initial approvals, and project management",
  },
  ...
  },
  {
    ...
    department: "Legal",
    description:
      "Oversees compliance training, policies, and regulatory requirements",
  },
  {
    ...
    description:
      "Manages workplace facilities, equipment, and resource booking",
  },
  {
    ...
    department: "Operations",
    description:
      "Manages workplace safety, incident reports, and safety training",
  },
];
...
export default function MockAccountInfo({
  onSelect,
  filterRoles,
}: MockAccountInfoProps) {
  ...
  return (
    <div className="mt-8 p-4 bg-gray-100 rounded-lg">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Click on an account to automatically fill login credentials
      </p>
