...
export default function Topbar({
  ...
  const notificationsData = [
    {
      id: "1",
      text: "New leave request from John Doe",
      time: "10 minutes ago",
      unread: true,
      priority: "high",
    ...
    {
      id: "2",
      text: "Your expense report #EXP0045 was approved",
      time: "1 hour ago",
      unread: true,
      priority: "medium",
      href: "/expenses",
    ...
    {
      id: "3",
      text: "Performance review scheduled for Jane Smith on 2024-08-15",
      time: "3 hours ago",
      unread: false,
      priority: "medium",
      href: "/performance",
    ...
    {
      id: "4",
      text: "Team meeting reminder: Tomorrow at 10 AM in Conference Room B",
      time: "5 hours ago",
      unread: false,
      priority: "low",
      href: "/calendar",
    ...
    {
      id: "5",
      text: "New training course assigned: Advanced Cybersecurity",
      time: "1 day ago",
      unread: false,
      priority: "low",
      href: "/training",
  ...
  const topBarThemeClasses = {
    ...
    dark: {
      // Example for dark theme consistency with shadcn patterns
      bg: "bg-slate-900",
      text: "text-slate-50",
  ...
  return (
    <div
      className={cn(
        "h-16 shadow-sm z-20 sticky top-0",
        currentTheme.bg,
        currentTheme.border,
      )}
    >
      <div className="flex items-center justify-between h-full px-3 sm:px-6">
        ...
        >
          <Search
            className={cn("absolute left-3 h-4 w-4", currentTheme.iconColor)}
          />
          <Input
            type="text"
            placeholder="Search..."
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-4">
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <Badge
                    variant="destructive"
                    className="absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-xs leading-none"
                  >
            ...
            >
              ...
              >
                <h3 className={cn("font-semibold text-sm", currentTheme.text)}>
                  Notifications
                </h3>
                          ...
                          <a
                            ...
                            className={cn(
                              ...
                              notification.unread
                                ...
                                : cn("hover:bg-muted", currentTheme.hoverBg),
                            )}
                          >
                            <div className="flex items-start">
                              <div
                                className={cn(
                                  "w-2 h-2 mt-1.5 rounded-full mr-2 flex-shrink-0",
                                  priorityClasses.dot,
                                )}
                              ></div>
          ...
          <Link href="/help" className="hidden sm:block">
            <Button
              variant="ghost"
              size="icon"
              className={cn(currentTheme.iconColor, currentTheme.hoverBg)}
            >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className={cn(
                  "flex items-center space-x-2 px-1 sm:px-2 py-1 h-auto",
                  currentTheme.hoverBg,
                )}
              >
                <Avatar className="h-8 w-8">
                  ...
                  <AvatarFallback
                    className={cn(
                      currentTheme.avatarFallbackBg,
                      currentTheme.avatarFallbackText,
                    )}
                  >
            ...
            >
              <DropdownMenuLabel>
                ...
                <p className="text-xs text-muted-foreground truncate">
                  {user?.position || role || "N/A"}
                </p>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              <div className="px-2 py-1.5">
                <Badge
                  variant={isDev && user?.role ? "secondary" : "default"}
                  className="mr-1"
                >
                  {role || "No role"}
                </Badge>
