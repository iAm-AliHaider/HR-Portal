...
import { usePermissions, hasAnyPermission, hasAllPermissions } from '../../hooks/usePermissions';
import { PermissionResource, PermissionAction } from '../../../packages/types/src/hr';
          ...
          <div className="flex items-center justify-center p-8 text-gray-500">
            <div className="text-center">
              <svg className="w-12 h-12 mx-auto mb-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m0 0v2m0-2h2m-2 0H10m9-7V9a7 7 0 00-14 0v1M5 10h14a2 2 0 012 2v7a2 2 0 01-2 2H5a2 2 0 01-2-2v-7a2 2 0 012-2z" />
              </svg>
...
export const PermissionButton: React.FC<PermissionButtonProps> = ({
  ...
  const baseClasses = 'inline-flex items-center px-4 py-2 border font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors';
