...
const InterviewForm = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (!interview.scheduled_at)
      newErrors.scheduled_at = "Schedule date and time are required";
    if (!interview.interviewer_ids?.length)
      newErrors.interviewer_ids = "At least one interviewer is required";
              ...
              <Box>
                ...
                {application && (
                  <HStack mt={1}>
                    ...
                    <Text fontSize="xs">
                      Applied for: Job #{application.job_id}
                    </Text>
                  </HStack>
                )}
              </Box>
