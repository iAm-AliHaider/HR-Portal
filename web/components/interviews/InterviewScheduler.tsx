  ...
  useEffect(() => {
    if (existingInterview) {
      ...
      if (
        ...
        Array.isArray(existingInterview.interviewers)
      ) {
        setSelectedInterviewers(
          existingInterview.interviewers.map((i: any) => i.id),
        );
      }
    } else {
        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div>
            ...
            <p className="text-gray-500">
              {jobTitle} - {stage.charAt(0).toUpperCase() + stage.slice(1)}{" "}
              Interview
            </p>
          </div>
          {existingInterview && (
                ...
                interviewers.map((interviewer) => (
                  <div
                    ...
                    onClick={() =>
                      ...
                      toggleInterviewer(interviewer.id)
                    }
                  >
          ...
          <div className="mt-6 space-y-3">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setSendCalendarInvite(checked as boolean)
                }
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setSendCandidateReminder(checked as boolean)
                }
              />
              ...
              <div className="border rounded-md p-4 bg-blue-50">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {
                        interviewDurations.find((d) => d.value === duration)
                          ?.label
                      }
                    </p>
                  </div>
