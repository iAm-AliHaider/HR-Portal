  ...
  const handleSubmit = async () => {
    if (
      ...
      toast({
        ...
        description:
          "Please fill in all required fields and select at least one interviewer.",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
    ...
    try {
      ...
      if (
        ...
        (formData.selectedRoomId || formData.selectedAssetIds.length > 0)
      ) {
              ...
              <TabPanels>
                  ...
                  <VStack spacing={4} align="stretch">
                        ...
                        <VStack spacing={2} align="stretch">
                          {mockInterviewers.map((interviewer) => (
                            ...
                            >
                              <HStack>
                                <Checkbox
                                  isChecked={formData.interviewerIds.includes(
                                    interviewer.id,
                                  )}
                                  onChange={() =>
                    ...
                    {formData.sendNotification && (
                      <Alert status="info" size="sm">
                        <AlertIcon />
                        <Text fontSize="sm">
                          Email notifications will be sent with interview
                          details and calendar invites.
                        </Text>
                      </Alert>
                    )}
                  </VStack>
                ...
                <TabPanel px={0}>
                  <InterviewBookingSection
                    ...
                    onRoomChange={(roomId) =>
                      handleInputChange("selectedRoomId", roomId)
                    }
                    onAssetsChange={(assetIds) =>
                      handleInputChange("selectedAssetIds", assetIds)
                    }
                  />
                </TabPanel>
              </TabPanels>
