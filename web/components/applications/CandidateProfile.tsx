                    ...
                    >
                      <Flex justify="space-between" wrap="wrap">
                        ...
                        >
                          ...
                          {edu.grade && (
                            <Text fontSize="sm">GPA: {edu.grade}</Text>
                          )}
                        </Box>
                      </Flex>
                      {edu.activities && (
          ...
          <Card mb={6} boxShadow="sm" bg={sectionBg}>
            ...
            <CardBody>
              <VStack spacing={4} align="stretch">
                {candidate.address && (
                  <Flex>
                    <Text fontWeight="bold" width="130px">
                      Address:
                    </Text>
                ...
                {candidate.preferred_salary_range && (
                  <Flex>
                    ...
                    <Text>
                      {candidate.preferred_salary_range.min.toLocaleString()} -{" "}
                      {candidate.preferred_salary_range.max.toLocaleString()}{" "}
                      {candidate.preferred_salary_range.currency}
                    </Text>
                  </Flex>
                )}
                ...
                <Flex>
                  ...
                  <Badge
                    colorScheme={
                      candidate.status === "active" ? "green" : "gray"
                    }
                  >
                    {candidate.status}
                  </Badge>
